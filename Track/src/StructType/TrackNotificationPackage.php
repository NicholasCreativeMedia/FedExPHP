...
class TrackNotificationPackage extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationRecipientDetail[]
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $destination
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationRecipientDetail[] $recipientDetails
     */
    public function __construct($trackingNumber = null, $trackingNumberUniqueIdentifiers = null, $carrierCode = null, $shipDate = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $destination = null, array $recipientDetails = array())
    {
        $this
     ...
     * @param string $trackingNumber
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage
     */
    public function setDestination(\NicholasCreativeMedia\FedExPHP\Track\StructType\Address $destination = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationRecipientDetail[]|null
     */
    ...
    public function setRecipientDetails(array $recipientDetails = array())
    {
        foreach ($recipientDetails as $trackNotificationPackageRecipientDetailsItem) {
            ...
            if (!$trackNotificationPackageRecipientDetailsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationRecipientDetail) {
                throw new \InvalidArgumentException(sprintf('The RecipientDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationRecipientDetail, "%s" given', is_object($trackNotificationPackageRecipientDetailsItem) ? get_class($trackNotificationPackageRecipientDetailsItem) : gettype($trackNotificationPackageRecipientDetailsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationRecipientDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage
     */
    public function addToRecipientDetails(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationRecipientDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationRecipientDetail) {
            throw new \InvalidArgumentException(sprintf('The RecipientDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationRecipientDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
