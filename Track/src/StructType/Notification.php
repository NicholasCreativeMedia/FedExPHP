...
class Notification extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationParameter[]
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationParameter[] $messageParameters
     */
    ...
    public function setSeverity($severity = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\NotificationSeverityType::valueIsValid($severity)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $severity, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\NotificationSeverityType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationParameter[]|null
     */
    ...
    public function setMessageParameters(array $messageParameters = array())
    {
        foreach ($messageParameters as $notificationMessageParametersItem) {
            ...
            if (!$notificationMessageParametersItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationParameter) {
                throw new \InvalidArgumentException(sprintf('The MessageParameters property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationParameter, "%s" given', is_object($notificationMessageParametersItem) ? get_class($notificationMessageParametersItem) : gettype($notificationMessageParametersItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationParameter $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Notification
     */
    public function addToMessageParameters(\NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationParameter $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationParameter) {
            throw new \InvalidArgumentException(sprintf('The MessageParameters property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationParameter, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
