...
class TrackEvent extends AbstractStructBase
{
     ...
     */
    public function __construct($timestamp = null, $eventType = null, $eventDescription = null, $statusExceptionCode = null, $statusExceptionDescription = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $address = null, $stationId = null, $arrivalLocation = null)
    {
        $this
     ...
     * Set Timestamp value
     * @param string $timestamp
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackEvent
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\ArrivalLocationType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\ArrivalLocationType::getValidValues()
    ...
    public function setArrivalLocation($arrivalLocation = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\ArrivalLocationType::valueIsValid($arrivalLocation)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $arrivalLocation, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\ArrivalLocationType::getValidValues())), __LINE__);
        }
