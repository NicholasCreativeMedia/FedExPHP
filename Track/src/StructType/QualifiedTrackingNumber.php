...
class QualifiedTrackingNumber extends AbstractStructBase
{
     ...
     */
    public function __construct($trackingNumber = null, $shipDate = null, $accountNumber = null, $carrier = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $destination = null)
    {
        $this
     ...
     * @param string $trackingNumber
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\QualifiedTrackingNumber
     */
    ...
    public function setCarrier($carrier = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\CarrierCodeType::valueIsValid($carrier)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $carrier, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\CarrierCodeType::getValidValues())), __LINE__);
        }
