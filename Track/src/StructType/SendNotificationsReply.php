...
class SendNotificationsReply extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage[]
     */
    public $Packages;
    /**
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage[] $packages
     */
    public function __construct($highestSeverity = null, array $notifications = array(), \NicholasCreativeMedia\FedExPHP\Track\StructType\VersionId $version = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\TransactionDetail $transactionDetail = null, $duplicateWaybill = null, $moreDataAvailable = null, $pagingToken = null, array $packages = array())
    {
        $this
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\SendNotificationsReply
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $sendNotificationsReplyNotificationsItem) {
            ...
            if (!$sendNotificationsReplyNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\Notification, "%s" given', is_object($sendNotificationsReplyNotificationsItem) ? get_class($sendNotificationsReplyNotificationsItem) : gettype($sendNotificationsReplyNotificationsItem)), __LINE__);
            }
        }
    ...
    /**
     * Get Packages value
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage[]|null
     */
    ...
    public function setPackages(array $packages = array())
    {
        foreach ($packages as $sendNotificationsReplyPackagesItem) {
            // validation for constraint: itemType
            if (!$sendNotificationsReplyPackagesItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage) {
                throw new \InvalidArgumentException(sprintf('The Packages property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage, "%s" given', is_object($sendNotificationsReplyPackagesItem) ? get_class($sendNotificationsReplyPackagesItem) : gettype($sendNotificationsReplyPackagesItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\SendNotificationsReply
     */
    public function addToPackages(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage) {
            throw new \InvalidArgumentException(sprintf('The Packages property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackNotificationPackage, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Packages[] = $item;
        return $this;
    }
