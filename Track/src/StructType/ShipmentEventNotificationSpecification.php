...
class ShipmentEventNotificationSpecification extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationDetail
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\ShipmentNotificationFormatSpecification
     */
     ...
     * @param string $role
     * @param string[] $events
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationDetail $notificationDetail
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\ShipmentNotificationFormatSpecification $formatSpecification
     */
    public function __construct($role = null, array $events = array(), \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationDetail $notificationDetail = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\ShipmentNotificationFormatSpecification $formatSpecification = null)
    {
        $this
            ->setRole($role)
            ->setEvents($events)
    ...
    /**
     * Set Role value
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\ShipmentNotificationRoleType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\ShipmentNotificationRoleType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $role
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\ShipmentEventNotificationSpecification
     */
    public function setRole($role = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\ShipmentNotificationRoleType::valueIsValid($role)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $role, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\ShipmentNotificationRoleType::getValidValues())), __LINE__);
        }
        $this->Role = $role;
        return $this;
    }
    ...
    public function setEvents(array $events = array())
    {
        ...
        foreach ($events as $shipmentEventNotificationSpecificationEventsItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\NotificationEventType::valueIsValid($shipmentEventNotificationSpecificationEventsItem)) {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\ShipmentEventNotificationSpecification
     */
    public function setNotificationDetail(\NicholasCreativeMedia\FedExPHP\Track\StructType\NotificationDetail $notificationDetail = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\ShipmentNotificationFormatSpecification|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\ShipmentEventNotificationSpecification
     */
    public function setFormatSpecification(\NicholasCreativeMedia\FedExPHP\Track\StructType\ShipmentNotificationFormatSpecification $formatSpecification = null)
    {
