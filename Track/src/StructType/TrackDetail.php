...
class TrackDetail extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\StringBarcode
     */
    public $Barcode;
    /**
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackStatusDetail
     */
    public $StatusDetail;
    /**
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackInformationNoteDetail[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomerExceptionRequestDetail[]
     */
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackReconciliation
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackOtherIdentifierDetail[]
     */
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackServiceDescriptionDetail
     */
    public $Service;
    /**
     * The PackageWeight
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\Weight
     */
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\Dimensions
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackChargeDetail[]
     */
    public $Charges;
    /**
     * The NickName
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\ContentRecord[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity[]
     */
    public $Commodities;
    /**
     * The ReturnDetail
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackReturnDetail
     */
    public $ReturnDetail;
    /**
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomsOptionDetail[]
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackAdvanceNotificationDetail
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialHandling[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackPayment[]
     */
    public $Payments;
    /**
     * The Shipper
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackingDateOrTimestamp[]
     */
    public $DatesOrTimes;
    /**
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\Distance
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\PieceCountVerificationDetail[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\AvailableImagesDetail[]
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\SignatureImageDetail
     */
    public $Signature;
    /**
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSplitShipmentPart[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\DeliveryOptionEligibilityDetail[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackEvent[]
     */
    public $Events;
    /**
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Notification $notification
     * @param string $trackingNumber
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\StringBarcode $barcode
     * @param string $trackingNumberUniqueIdentifier
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackStatusDetail $statusDetail
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackInformationNoteDetail[] $informationNotes
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomerExceptionRequestDetail[] $customerExceptionRequests
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackReconciliation $reconciliation
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\ContactAndAddress $productionLocationContactAndAddress
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackOtherIdentifierDetail[] $otherIdentifiers
     * @param string $formId
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackServiceDescriptionDetail $service
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $packageWeight
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Dimensions $packageDimensions
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $packageDimensionalWeight
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $shipmentWeight
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackChargeDetail[] $charges
     * @param string $nickName
     * @param string $notes
     * @param string[] $attributes
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\ContentRecord[] $shipmentContents
     * @param string[] $packageContents
     * @param string $clearanceLocationCode
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity[] $commodities
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackReturnDetail $returnDetail
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomsOptionDetail[] $customsOptionDetails
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackAdvanceNotificationDetail $advanceNotificationDetail
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialHandling[] $specialHandlings
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackPayment[] $payments
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Contact $shipper
     * @param string $possessionStatus
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $shipperAddress
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $originLocationAddress
     * @param string $originStationId
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackingDateOrTimestamp[] $datesOrTimes
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Distance $totalTransitDistance
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Distance $distanceToDestination
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction[] $specialInstructions
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Contact $recipient
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $lastUpdatedDestinationAddress
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $destinationAddress
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Contact $holdAtLocationContact
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $holdAtLocationAddress
     * @param string $destinationStationId
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $destinationLocationAddress
     * @param string $destinationLocationType
     * @param string $destinationLocationTimeZoneOffset
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $actualDeliveryAddress
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\PieceCountVerificationDetail[] $pieceCountVerificationDetails
     * @param int $totalUniqueAddressCountInConsolidation
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\AvailableImagesDetail[] $availableImages
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\SignatureImageDetail $signature
     * @param string[] $notificationEventsAvailable
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSplitShipmentPart[] $splitShipmentParts
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\DeliveryOptionEligibilityDetail[] $deliveryOptionEligibilityDetails
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackEvent[] $events
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Track\StructType\Notification $notification = null, $trackingNumber = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\StringBarcode $barcode = null, $trackingNumberUniqueIdentifier = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackStatusDetail $statusDetail = null, array $informationNotes = array(), array $customerExceptionRequests = array(), \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackReconciliation $reconciliation = null, $serviceCommitMessage = null, $destinationServiceArea = null, $destinationServiceAreaDescription = null, $carrierCode = null, $operatingCompany = null, $operatingCompanyOrCarrierDescription = null, $cartageAgentCompanyName = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\ContactAndAddress $productionLocationContactAndAddress = null, array $otherIdentifiers = array(), $formId = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackServiceDescriptionDetail $service = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $packageWeight = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Dimensions $packageDimensions = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $packageDimensionalWeight = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $shipmentWeight = null, $packaging = null, $packagingType = null, $physicalPackagingType = null, $packageSequenceNumber = null, $packageCount = null, $creatorSoftwareId = null, array $charges = array(), $nickName = null, $notes = null, array $attributes = array(), array $shipmentContents = array(), array $packageContents = array(), $clearanceLocationCode = null, array $commodities = array(), \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackReturnDetail $returnDetail = null, array $customsOptionDetails = array(), \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackAdvanceNotificationDetail $advanceNotificationDetail = null, array $specialHandlings = array(), array $payments = array(), \NicholasCreativeMedia\FedExPHP\Track\StructType\Contact $shipper = null, $possessionStatus = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $shipperAddress = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $originLocationAddress = null, $originStationId = null, array $datesOrTimes = array(), \NicholasCreativeMedia\FedExPHP\Track\StructType\Distance $totalTransitDistance = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Distance $distanceToDestination = null, array $specialInstructions = array(), \NicholasCreativeMedia\FedExPHP\Track\StructType\Contact $recipient = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $lastUpdatedDestinationAddress = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $destinationAddress = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Contact $holdAtLocationContact = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $holdAtLocationAddress = null, $destinationStationId = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $destinationLocationAddress = null, $destinationLocationType = null, $destinationLocationTimeZoneOffset = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Address $actualDeliveryAddress = null, $officeOrderDeliveryMethod = null, $deliveryLocationType = null, $deliveryLocationDescription = null, $deliveryAttempts = null, $deliverySignatureName = null, array $pieceCountVerificationDetails = array(), $totalUniqueAddressCountInConsolidation = null, array $availableImages = array(), \NicholasCreativeMedia\FedExPHP\Track\StructType\SignatureImageDetail $signature = null, array $notificationEventsAvailable = array(), array $splitShipmentParts = array(), array $deliveryOptionEligibilityDetails = array(), array $events = array())
    {
        $this
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Notification $notification
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setNotification(\NicholasCreativeMedia\FedExPHP\Track\StructType\Notification $notification = null)
    {
    ...
    /**
     * Get Barcode value
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\StringBarcode|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setBarcode(\NicholasCreativeMedia\FedExPHP\Track\StructType\StringBarcode $barcode = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackStatusDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setStatusDetail(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackStatusDetail $statusDetail = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackInformationNoteDetail[]|null
     */
    ...
    public function setInformationNotes(array $informationNotes = array())
    {
        foreach ($informationNotes as $trackDetailInformationNotesItem) {
            ...
            if (!$trackDetailInformationNotesItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackInformationNoteDetail) {
                throw new \InvalidArgumentException(sprintf('The InformationNotes property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackInformationNoteDetail, "%s" given', is_object($trackDetailInformationNotesItem) ? get_class($trackDetailInformationNotesItem) : gettype($trackDetailInformationNotesItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackInformationNoteDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToInformationNotes(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackInformationNoteDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackInformationNoteDetail) {
            throw new \InvalidArgumentException(sprintf('The InformationNotes property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackInformationNoteDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomerExceptionRequestDetail[]|null
     */
    ...
    public function setCustomerExceptionRequests(array $customerExceptionRequests = array())
    {
        foreach ($customerExceptionRequests as $trackDetailCustomerExceptionRequestsItem) {
            // validation for constraint: itemType
            if (!$trackDetailCustomerExceptionRequestsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomerExceptionRequestDetail) {
                throw new \InvalidArgumentException(sprintf('The CustomerExceptionRequests property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomerExceptionRequestDetail, "%s" given', is_object($trackDetailCustomerExceptionRequestsItem) ? get_class($trackDetailCustomerExceptionRequestsItem) : gettype($trackDetailCustomerExceptionRequestsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomerExceptionRequestDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToCustomerExceptionRequests(\NicholasCreativeMedia\FedExPHP\Track\StructType\CustomerExceptionRequestDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomerExceptionRequestDetail) {
            throw new \InvalidArgumentException(sprintf('The CustomerExceptionRequests property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomerExceptionRequestDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackReconciliation|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setReconciliation(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackReconciliation $reconciliation = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\OperatingCompanyType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\OperatingCompanyType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $operatingCompany
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\OperatingCompanyType::valueIsValid($operatingCompany)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $operatingCompany, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\OperatingCompanyType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setProductionLocationContactAndAddress(\NicholasCreativeMedia\FedExPHP\Track\StructType\ContactAndAddress $productionLocationContactAndAddress = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackOtherIdentifierDetail[]|null
     */
    ...
    public function setOtherIdentifiers(array $otherIdentifiers = array())
    {
        foreach ($otherIdentifiers as $trackDetailOtherIdentifiersItem) {
            // validation for constraint: itemType
            if (!$trackDetailOtherIdentifiersItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackOtherIdentifierDetail) {
                throw new \InvalidArgumentException(sprintf('The OtherIdentifiers property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackOtherIdentifierDetail, "%s" given', is_object($trackDetailOtherIdentifiersItem) ? get_class($trackDetailOtherIdentifiersItem) : gettype($trackDetailOtherIdentifiersItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackOtherIdentifierDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToOtherIdentifiers(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackOtherIdentifierDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackOtherIdentifierDetail) {
            throw new \InvalidArgumentException(sprintf('The OtherIdentifiers property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackOtherIdentifierDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
    ...
    /**
     * Get Service value
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackServiceDescriptionDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setService(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackServiceDescriptionDetail $service = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Weight|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setPackageWeight(\NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $packageWeight = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Dimensions|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setPackageDimensions(\NicholasCreativeMedia\FedExPHP\Track\StructType\Dimensions $packageDimensions = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setPackageDimensionalWeight(\NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $packageDimensionalWeight = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setShipmentWeight(\NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $shipmentWeight = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\PackagingType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\PackagingType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $packagingType
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\PackagingType::valueIsValid($packagingType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $packagingType, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\PackagingType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\PhysicalPackagingType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\PhysicalPackagingType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $physicalPackagingType
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\PhysicalPackagingType::valueIsValid($physicalPackagingType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $physicalPackagingType, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\PhysicalPackagingType::getValidValues())), __LINE__);
        }
    ...
    /**
     * Get Charges value
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackChargeDetail[]|null
     */
    ...
    public function setCharges(array $charges = array())
    {
        foreach ($charges as $trackDetailChargesItem) {
            // validation for constraint: itemType
            if (!$trackDetailChargesItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackChargeDetail) {
                throw new \InvalidArgumentException(sprintf('The Charges property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackChargeDetail, "%s" given', is_object($trackDetailChargesItem) ? get_class($trackDetailChargesItem) : gettype($trackDetailChargesItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackChargeDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToCharges(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackChargeDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackChargeDetail) {
            throw new \InvalidArgumentException(sprintf('The Charges property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackChargeDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Charges[] = $item;
        return $this;
    }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDetailAttributeType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDetailAttributeType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string[] $attributes
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setAttributes(array $attributes = array())
    {
        ...
        foreach ($attributes as $trackDetailAttributesItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDetailAttributeType::valueIsValid($trackDetailAttributesItem)) {
                $invalidValues[] = var_export($trackDetailAttributesItem);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDetailAttributeType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDetailAttributeType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDetailAttributeType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\ContentRecord[]|null
     */
    ...
    public function setShipmentContents(array $shipmentContents = array())
    {
        foreach ($shipmentContents as $trackDetailShipmentContentsItem) {
            // validation for constraint: itemType
            if (!$trackDetailShipmentContentsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\ContentRecord) {
                throw new \InvalidArgumentException(sprintf('The ShipmentContents property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\ContentRecord, "%s" given', is_object($trackDetailShipmentContentsItem) ? get_class($trackDetailShipmentContentsItem) : gettype($trackDetailShipmentContentsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\ContentRecord $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToShipmentContents(\NicholasCreativeMedia\FedExPHP\Track\StructType\ContentRecord $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\ContentRecord) {
            throw new \InvalidArgumentException(sprintf('The ShipmentContents property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\ContentRecord, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity[]|null
     */
    ...
    public function setCommodities(array $commodities = array())
    {
        foreach ($commodities as $trackDetailCommoditiesItem) {
            // validation for constraint: itemType
            if (!$trackDetailCommoditiesItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity) {
                throw new \InvalidArgumentException(sprintf('The Commodities property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity, "%s" given', is_object($trackDetailCommoditiesItem) ? get_class($trackDetailCommoditiesItem) : gettype($trackDetailCommoditiesItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToCommodities(\NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity) {
            throw new \InvalidArgumentException(sprintf('The Commodities property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackReturnDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setReturnDetail(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackReturnDetail $returnDetail = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomsOptionDetail[]|null
     */
    ...
    public function setCustomsOptionDetails(array $customsOptionDetails = array())
    {
        foreach ($customsOptionDetails as $trackDetailCustomsOptionDetailsItem) {
            // validation for constraint: itemType
            if (!$trackDetailCustomsOptionDetailsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomsOptionDetail) {
                throw new \InvalidArgumentException(sprintf('The CustomsOptionDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomsOptionDetail, "%s" given', is_object($trackDetailCustomsOptionDetailsItem) ? get_class($trackDetailCustomsOptionDetailsItem) : gettype($trackDetailCustomsOptionDetailsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomsOptionDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToCustomsOptionDetails(\NicholasCreativeMedia\FedExPHP\Track\StructType\CustomsOptionDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomsOptionDetail) {
            throw new \InvalidArgumentException(sprintf('The CustomsOptionDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\CustomsOptionDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackAdvanceNotificationDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setAdvanceNotificationDetail(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackAdvanceNotificationDetail $advanceNotificationDetail = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialHandling[]|null
     */
    ...
    public function setSpecialHandlings(array $specialHandlings = array())
    {
        foreach ($specialHandlings as $trackDetailSpecialHandlingsItem) {
            // validation for constraint: itemType
            if (!$trackDetailSpecialHandlingsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialHandling) {
                throw new \InvalidArgumentException(sprintf('The SpecialHandlings property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialHandling, "%s" given', is_object($trackDetailSpecialHandlingsItem) ? get_class($trackDetailSpecialHandlingsItem) : gettype($trackDetailSpecialHandlingsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialHandling $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToSpecialHandlings(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialHandling $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialHandling) {
            throw new \InvalidArgumentException(sprintf('The SpecialHandlings property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialHandling, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
    ...
    /**
     * Get Payments value
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackPayment[]|null
     */
    ...
    public function setPayments(array $payments = array())
    {
        foreach ($payments as $trackDetailPaymentsItem) {
            // validation for constraint: itemType
            if (!$trackDetailPaymentsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackPayment) {
                throw new \InvalidArgumentException(sprintf('The Payments property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackPayment, "%s" given', is_object($trackDetailPaymentsItem) ? get_class($trackDetailPaymentsItem) : gettype($trackDetailPaymentsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackPayment $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToPayments(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackPayment $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackPayment) {
            throw new \InvalidArgumentException(sprintf('The Payments property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackPayment, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Payments[] = $item;
        return $this;
    }
    /**
     * Get Shipper value
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Contact|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setShipper(\NicholasCreativeMedia\FedExPHP\Track\StructType\Contact $shipper = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackPossessionStatusType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackPossessionStatusType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $possessionStatus
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackPossessionStatusType::valueIsValid($possessionStatus)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $possessionStatus, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackPossessionStatusType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setShipperAddress(\NicholasCreativeMedia\FedExPHP\Track\StructType\Address $shipperAddress = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setOriginLocationAddress(\NicholasCreativeMedia\FedExPHP\Track\StructType\Address $originLocationAddress = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackingDateOrTimestamp[]|null
     */
    ...
    public function setDatesOrTimes(array $datesOrTimes = array())
    {
        foreach ($datesOrTimes as $trackDetailDatesOrTimesItem) {
            // validation for constraint: itemType
            if (!$trackDetailDatesOrTimesItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackingDateOrTimestamp) {
                throw new \InvalidArgumentException(sprintf('The DatesOrTimes property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackingDateOrTimestamp, "%s" given', is_object($trackDetailDatesOrTimesItem) ? get_class($trackDetailDatesOrTimesItem) : gettype($trackDetailDatesOrTimesItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackingDateOrTimestamp $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToDatesOrTimes(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackingDateOrTimestamp $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackingDateOrTimestamp) {
            throw new \InvalidArgumentException(sprintf('The DatesOrTimes property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackingDateOrTimestamp, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Distance|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setTotalTransitDistance(\NicholasCreativeMedia\FedExPHP\Track\StructType\Distance $totalTransitDistance = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setDistanceToDestination(\NicholasCreativeMedia\FedExPHP\Track\StructType\Distance $distanceToDestination = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction[]|null
     */
    ...
    public function setSpecialInstructions(array $specialInstructions = array())
    {
        foreach ($specialInstructions as $trackDetailSpecialInstructionsItem) {
            // validation for constraint: itemType
            if (!$trackDetailSpecialInstructionsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction) {
                throw new \InvalidArgumentException(sprintf('The SpecialInstructions property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction, "%s" given', is_object($trackDetailSpecialInstructionsItem) ? get_class($trackDetailSpecialInstructionsItem) : gettype($trackDetailSpecialInstructionsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToSpecialInstructions(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction) {
            throw new \InvalidArgumentException(sprintf('The SpecialInstructions property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setRecipient(\NicholasCreativeMedia\FedExPHP\Track\StructType\Contact $recipient = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setLastUpdatedDestinationAddress(\NicholasCreativeMedia\FedExPHP\Track\StructType\Address $lastUpdatedDestinationAddress = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setDestinationAddress(\NicholasCreativeMedia\FedExPHP\Track\StructType\Address $destinationAddress = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setHoldAtLocationContact(\NicholasCreativeMedia\FedExPHP\Track\StructType\Contact $holdAtLocationContact = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setHoldAtLocationAddress(\NicholasCreativeMedia\FedExPHP\Track\StructType\Address $holdAtLocationAddress = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setDestinationLocationAddress(\NicholasCreativeMedia\FedExPHP\Track\StructType\Address $destinationLocationAddress = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\FedExLocationType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\FedExLocationType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $destinationLocationType
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\FedExLocationType::valueIsValid($destinationLocationType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $destinationLocationType, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\FedExLocationType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setActualDeliveryAddress(\NicholasCreativeMedia\FedExPHP\Track\StructType\Address $actualDeliveryAddress = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\OfficeOrderDeliveryMethodType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\OfficeOrderDeliveryMethodType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $officeOrderDeliveryMethod
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\OfficeOrderDeliveryMethodType::valueIsValid($officeOrderDeliveryMethod)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $officeOrderDeliveryMethod, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\OfficeOrderDeliveryMethodType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDeliveryLocationType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDeliveryLocationType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $deliveryLocationType
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDeliveryLocationType::valueIsValid($deliveryLocationType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $deliveryLocationType, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDeliveryLocationType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\PieceCountVerificationDetail[]|null
     */
    ...
    public function setPieceCountVerificationDetails(array $pieceCountVerificationDetails = array())
    {
        foreach ($pieceCountVerificationDetails as $trackDetailPieceCountVerificationDetailsItem) {
            // validation for constraint: itemType
            if (!$trackDetailPieceCountVerificationDetailsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\PieceCountVerificationDetail) {
                throw new \InvalidArgumentException(sprintf('The PieceCountVerificationDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\PieceCountVerificationDetail, "%s" given', is_object($trackDetailPieceCountVerificationDetailsItem) ? get_class($trackDetailPieceCountVerificationDetailsItem) : gettype($trackDetailPieceCountVerificationDetailsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\PieceCountVerificationDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToPieceCountVerificationDetails(\NicholasCreativeMedia\FedExPHP\Track\StructType\PieceCountVerificationDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\PieceCountVerificationDetail) {
            throw new \InvalidArgumentException(sprintf('The PieceCountVerificationDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\PieceCountVerificationDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\AvailableImagesDetail[]|null
     */
    ...
    public function setAvailableImages(array $availableImages = array())
    {
        foreach ($availableImages as $trackDetailAvailableImagesItem) {
            // validation for constraint: itemType
            if (!$trackDetailAvailableImagesItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\AvailableImagesDetail) {
                throw new \InvalidArgumentException(sprintf('The AvailableImages property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\AvailableImagesDetail, "%s" given', is_object($trackDetailAvailableImagesItem) ? get_class($trackDetailAvailableImagesItem) : gettype($trackDetailAvailableImagesItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\AvailableImagesDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToAvailableImages(\NicholasCreativeMedia\FedExPHP\Track\StructType\AvailableImagesDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\AvailableImagesDetail) {
            throw new \InvalidArgumentException(sprintf('The AvailableImages property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\AvailableImagesDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
    ...
    /**
     * Get Signature value
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\SignatureImageDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function setSignature(\NicholasCreativeMedia\FedExPHP\Track\StructType\SignatureImageDetail $signature = null)
    {
    ...
    public function setNotificationEventsAvailable(array $notificationEventsAvailable = array())
    {
        ...
        foreach ($notificationEventsAvailable as $trackDetailNotificationEventsAvailableItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\NotificationEventType::valueIsValid($trackDetailNotificationEventsAvailableItem)) {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSplitShipmentPart[]|null
     */
    ...
    public function setSplitShipmentParts(array $splitShipmentParts = array())
    {
        foreach ($splitShipmentParts as $trackDetailSplitShipmentPartsItem) {
            // validation for constraint: itemType
            if (!$trackDetailSplitShipmentPartsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSplitShipmentPart) {
                throw new \InvalidArgumentException(sprintf('The SplitShipmentParts property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSplitShipmentPart, "%s" given', is_object($trackDetailSplitShipmentPartsItem) ? get_class($trackDetailSplitShipmentPartsItem) : gettype($trackDetailSplitShipmentPartsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSplitShipmentPart $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToSplitShipmentParts(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSplitShipmentPart $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSplitShipmentPart) {
            throw new \InvalidArgumentException(sprintf('The SplitShipmentParts property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSplitShipmentPart, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\DeliveryOptionEligibilityDetail[]|null
     */
    ...
    public function setDeliveryOptionEligibilityDetails(array $deliveryOptionEligibilityDetails = array())
    {
        foreach ($deliveryOptionEligibilityDetails as $trackDetailDeliveryOptionEligibilityDetailsItem) {
            // validation for constraint: itemType
            if (!$trackDetailDeliveryOptionEligibilityDetailsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\DeliveryOptionEligibilityDetail) {
                throw new \InvalidArgumentException(sprintf('The DeliveryOptionEligibilityDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\DeliveryOptionEligibilityDetail, "%s" given', is_object($trackDetailDeliveryOptionEligibilityDetailsItem) ? get_class($trackDetailDeliveryOptionEligibilityDetailsItem) : gettype($trackDetailDeliveryOptionEligibilityDetailsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\DeliveryOptionEligibilityDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToDeliveryOptionEligibilityDetails(\NicholasCreativeMedia\FedExPHP\Track\StructType\DeliveryOptionEligibilityDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\DeliveryOptionEligibilityDetail) {
            throw new \InvalidArgumentException(sprintf('The DeliveryOptionEligibilityDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\DeliveryOptionEligibilityDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
    ...
    /**
     * Get Events value
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackEvent[]|null
     */
    ...
    public function setEvents(array $events = array())
    {
        foreach ($events as $trackDetailEventsItem) {
            // validation for constraint: itemType
            if (!$trackDetailEventsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackEvent) {
                throw new \InvalidArgumentException(sprintf('The Events property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackEvent, "%s" given', is_object($trackDetailEventsItem) ? get_class($trackDetailEventsItem) : gettype($trackDetailEventsItem)), __LINE__);
            }
        }
        $this->Events = $events;
        return $this;
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackEvent $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail
     */
    public function addToEvents(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackEvent $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackEvent) {
            throw new \InvalidArgumentException(sprintf('The Events property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackEvent, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Events[] = $item;
        return $this;
    }
