...
class PieceCountVerificationDetail extends AbstractStructBase
{
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\PieceCountLocationType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\PieceCountLocationType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $countLocationType
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\PieceCountVerificationDetail
     */
    public function setCountLocationType($countLocationType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\PieceCountLocationType::valueIsValid($countLocationType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $countLocationType, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\PieceCountLocationType::getValidValues())), __LINE__);
        }
