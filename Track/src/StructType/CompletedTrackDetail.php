...
class CompletedTrackDetail extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail[]
     */
    public $TrackDetails;
    /**
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail[] $trackDetails
     */
     ...
     * @param string $highestSeverity
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\CompletedTrackDetail
     */
    ...
    public function setNotifications(array $notifications = array())
    {
        foreach ($notifications as $completedTrackDetailNotificationsItem) {
            ...
            if (!$completedTrackDetailNotificationsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\Notification) {
                throw new \InvalidArgumentException(sprintf('The Notifications property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\Notification, "%s" given', is_object($completedTrackDetailNotificationsItem) ? get_class($completedTrackDetailNotificationsItem) : gettype($completedTrackDetailNotificationsItem)), __LINE__);
            }
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail[]|null
     */
    ...
    public function setTrackDetails(array $trackDetails = array())
    {
        foreach ($trackDetails as $completedTrackDetailTrackDetailsItem) {
            // validation for constraint: itemType
            if (!$completedTrackDetailTrackDetailsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail) {
                throw new \InvalidArgumentException(sprintf('The TrackDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail, "%s" given', is_object($completedTrackDetailTrackDetailsItem) ? get_class($completedTrackDetailTrackDetailsItem) : gettype($completedTrackDetailTrackDetailsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\CompletedTrackDetail
     */
    public function addToTrackDetails(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail) {
            throw new \InvalidArgumentException(sprintf('The TrackDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
