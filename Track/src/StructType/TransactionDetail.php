...
class TransactionDetail extends AbstractStructBase
{
     ...
     */
    public function __construct($customerTransactionId = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Localization $localization = null)
    {
        $this
     ...
     * @param string $customerTransactionId
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TransactionDetail
     */
