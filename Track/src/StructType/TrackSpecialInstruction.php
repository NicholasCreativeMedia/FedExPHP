...
class TrackSpecialInstruction extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\SpecialInstructionStatusDetail
     */
    public $StatusDetail;
    /**
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\AppointmentDetail
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\SpecialInstructionStatusDetail $statusDetail
     * @param string $originalEstimatedDeliveryTimestamp
     * @param string $originalRequestTime
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\AppointmentDetail $requestedAppointmentTime
     */
    public function __construct($description = null, $deliveryOption = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\SpecialInstructionStatusDetail $statusDetail = null, $originalEstimatedDeliveryTimestamp = null, $originalRequestTime = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\AppointmentDetail $requestedAppointmentTime = null)
    {
        $this
     ...
     * @param string $description
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDeliveryOptionType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDeliveryOptionType::getValidValues()
    ...
    public function setDeliveryOption($deliveryOption = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDeliveryOptionType::valueIsValid($deliveryOption)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $deliveryOption, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackDeliveryOptionType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\SpecialInstructionStatusDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction
     */
    public function setStatusDetail(\NicholasCreativeMedia\FedExPHP\Track\StructType\SpecialInstructionStatusDetail $statusDetail = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\AppointmentDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSpecialInstruction
     */
    public function setRequestedAppointmentTime(\NicholasCreativeMedia\FedExPHP\Track\StructType\AppointmentDetail $requestedAppointmentTime = null)
    {
