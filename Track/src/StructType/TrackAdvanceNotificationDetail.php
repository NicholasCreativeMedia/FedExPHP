...
class TrackAdvanceNotificationDetail extends AbstractStructBase
{
     ...
     * @param string $estimatedTimeOfArrival
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackAdvanceNotificationDetail
     */
    ...
    /**
     * Set Status value
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackAdvanceNotificationStatusType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackAdvanceNotificationStatusType::getValidValues()
    ...
    public function setStatus($status = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackAdvanceNotificationStatusType::valueIsValid($status)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $status, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackAdvanceNotificationStatusType::getValidValues())), __LINE__);
        }
        $this->Status = $status;
        return $this;
    }
