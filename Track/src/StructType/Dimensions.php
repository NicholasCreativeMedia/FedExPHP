...
class Dimensions extends AbstractStructBase
{
     ...
     * Set Length value
     * @param int $length
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Dimensions
     */
    ...
    /**
     * Set Units value
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\LinearUnits::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\LinearUnits::getValidValues()
    ...
    public function setUnits($units = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\LinearUnits::valueIsValid($units)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $units, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\LinearUnits::getValidValues())), __LINE__);
        }
        $this->Units = $units;
        return $this;
    }
