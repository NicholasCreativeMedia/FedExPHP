...
class Commodity extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\Measure[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\EdtExciseCondition[]
     */
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\NaftaCommodityDetail
     */
    public $NaftaDetail;
    /**
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $weight
     * @param float $quantity
     * @param string $quantityUnits
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Measure[] $additionalMeasures
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Money $unitPrice
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Money $customsValue
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\EdtExciseCondition[] $exciseConditions
     * @param string $exportLicenseNumber
     * @param string $exportLicenseExpirationDate
     * @param string $cIMarksAndNumbers
     * @param string $partNumber
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\NaftaCommodityDetail $naftaDetail
     */
    public function __construct($commodityId = null, $name = null, $numberOfPieces = null, $description = null, $purpose = null, $countryOfManufacture = null, $harmonizedCode = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $weight = null, $quantity = null, $quantityUnits = null, array $additionalMeasures = array(), \NicholasCreativeMedia\FedExPHP\Track\StructType\Money $unitPrice = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\Money $customsValue = null, array $exciseConditions = array(), $exportLicenseNumber = null, $exportLicenseExpirationDate = null, $cIMarksAndNumbers = null, $partNumber = null, \NicholasCreativeMedia\FedExPHP\Track\StructType\NaftaCommodityDetail $naftaDetail = null)
    {
        $this
     ...
     * @param string $commodityId
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity
     */
    ...
    /**
     * Set Purpose value
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\CommodityPurposeType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\CommodityPurposeType::getValidValues()
    ...
    public function setPurpose($purpose = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\CommodityPurposeType::valueIsValid($purpose)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $purpose, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\CommodityPurposeType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity
     */
    public function setWeight(\NicholasCreativeMedia\FedExPHP\Track\StructType\Weight $weight = null)
    {
        $this->Weight = $weight;
        return $this;
    }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Measure[]|null
     */
    ...
    public function setAdditionalMeasures(array $additionalMeasures = array())
    {
        foreach ($additionalMeasures as $commodityAdditionalMeasuresItem) {
            ...
            if (!$commodityAdditionalMeasuresItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\Measure) {
                throw new \InvalidArgumentException(sprintf('The AdditionalMeasures property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\Measure, "%s" given', is_object($commodityAdditionalMeasuresItem) ? get_class($commodityAdditionalMeasuresItem) : gettype($commodityAdditionalMeasuresItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\Measure $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity
     */
    public function addToAdditionalMeasures(\NicholasCreativeMedia\FedExPHP\Track\StructType\Measure $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\Measure) {
            throw new \InvalidArgumentException(sprintf('The AdditionalMeasures property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\Measure, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity
     */
    public function setUnitPrice(\NicholasCreativeMedia\FedExPHP\Track\StructType\Money $unitPrice = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity
     */
    public function setCustomsValue(\NicholasCreativeMedia\FedExPHP\Track\StructType\Money $customsValue = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\EdtExciseCondition[]|null
     */
    ...
    public function setExciseConditions(array $exciseConditions = array())
    {
        foreach ($exciseConditions as $commodityExciseConditionsItem) {
            // validation for constraint: itemType
            if (!$commodityExciseConditionsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\EdtExciseCondition) {
                throw new \InvalidArgumentException(sprintf('The ExciseConditions property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\EdtExciseCondition, "%s" given', is_object($commodityExciseConditionsItem) ? get_class($commodityExciseConditionsItem) : gettype($commodityExciseConditionsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\EdtExciseCondition $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity
     */
    public function addToExciseConditions(\NicholasCreativeMedia\FedExPHP\Track\StructType\EdtExciseCondition $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\EdtExciseCondition) {
            throw new \InvalidArgumentException(sprintf('The ExciseConditions property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\EdtExciseCondition, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\NaftaCommodityDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\Commodity
     */
    public function setNaftaDetail(\NicholasCreativeMedia\FedExPHP\Track\StructType\NaftaCommodityDetail $naftaDetail = null)
    {
