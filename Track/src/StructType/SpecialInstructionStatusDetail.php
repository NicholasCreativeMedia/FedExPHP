...
class SpecialInstructionStatusDetail extends AbstractStructBase
{
    ...
    /**
     * Set Status value
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\SpecialInstructionsStatusCode::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\SpecialInstructionsStatusCode::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $status
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\SpecialInstructionStatusDetail
     */
    public function setStatus($status = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\SpecialInstructionsStatusCode::valueIsValid($status)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $status, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\SpecialInstructionsStatusCode::getValidValues())), __LINE__);
        }
        $this->Status = $status;
        return $this;
    }
