...
class TrackRequest extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSelectionDetail[]
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSelectionDetail[] $selectionDetails
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\WebAuthenticationDetail $webAuthenticationDetail
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackRequest
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSelectionDetail[]|null
     */
    ...
    public function setSelectionDetails(array $selectionDetails = array())
    {
        foreach ($selectionDetails as $trackRequestSelectionDetailsItem) {
            ...
            if (!$trackRequestSelectionDetailsItem instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSelectionDetail) {
                throw new \InvalidArgumentException(sprintf('The SelectionDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSelectionDetail, "%s" given', is_object($trackRequestSelectionDetailsItem) ? get_class($trackRequestSelectionDetailsItem) : gettype($trackRequestSelectionDetailsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSelectionDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackRequest
     */
    public function addToSelectionDetails(\NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSelectionDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSelectionDetail) {
            throw new \InvalidArgumentException(sprintf('The SelectionDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackSelectionDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackRequestProcessingOptionType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackRequestProcessingOptionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string[] $processingOptions
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackRequest
     */
    public function setProcessingOptions(array $processingOptions = array())
    {
        ...
        foreach ($processingOptions as $trackRequestProcessingOptionsItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackRequestProcessingOptionType::valueIsValid($trackRequestProcessingOptionsItem)) {
                $invalidValues[] = var_export($trackRequestProcessingOptionsItem);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackRequestProcessingOptionType::getValidValues())), __LINE__);
        }
    ...
    public function addToProcessingOptions($item)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackRequestProcessingOptionType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\TrackRequestProcessingOptionType::getValidValues())), __LINE__);
        }
