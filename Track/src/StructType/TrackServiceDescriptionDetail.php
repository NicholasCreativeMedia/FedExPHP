...
class TrackServiceDescriptionDetail extends AbstractStructBase
{
    ...
    /**
     * Set Type value
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\ServiceType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Track\EnumType\ServiceType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \NicholasCreativeMedia\FedExPHP\Track\StructType\TrackServiceDescriptionDetail
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Track\EnumType\ServiceType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \NicholasCreativeMedia\FedExPHP\Track\EnumType\ServiceType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
