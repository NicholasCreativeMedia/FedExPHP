...
class CommitDetail extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\ServiceSubOptionDetail
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\CleansedAddressAndLocationDetail
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\DelayDetail[]
     */
    public $DelayDetails;
    /**
     * The DocumentContent
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\FreightCommitDetail
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\ServiceSubOptionDetail $appliedSubOptions
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\SignatureOptionDetail $derivedShipmentSignatureOption
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\SignatureOptionDetail[] $derivedPackageSignatureOptions
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\CleansedAddressAndLocationDetail $derivedOriginDetail
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\CleansedAddressAndLocationDetail $derivedDestinationDetail
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Address $brokerAddress
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Notification[] $commitMessages
     * @param string[] $deliveryMessages
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\DelayDetail[] $delayDetails
     * @param string $documentContent
     * @param string[] $requiredDocuments
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\FreightCommitDetail $freightCommitDetail
     */
    public function __construct($commodityName = null, $serviceType = null, array $appliedOptions = array(), \NicholasCreativeMedia\FedExPHP\Rate\StructType\ServiceSubOptionDetail $appliedSubOptions = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\SignatureOptionDetail $derivedShipmentSignatureOption = null, array $derivedPackageSignatureOptions = array(), \NicholasCreativeMedia\FedExPHP\Rate\StructType\CleansedAddressAndLocationDetail $derivedOriginDetail = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\CleansedAddressAndLocationDetail $derivedDestinationDetail = null, $commitTimestamp = null, $dayOfWeek = null, $transitTime = null, $maximumTransitTime = null, $destinationServiceArea = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Address $brokerAddress = null, $brokerLocationId = null, $brokerCommitTimestamp = null, $brokerCommitDayOfWeek = null, $brokerToDestinationDays = null, $proofOfDeliveryDate = null, $proofOfDeliveryDayOfWeek = null, array $commitMessages = array(), array $deliveryMessages = array(), array $delayDetails = array(), $documentContent = null, array $requiredDocuments = array(), \NicholasCreativeMedia\FedExPHP\Rate\StructType\FreightCommitDetail $freightCommitDetail = null)
    {
        $this
     ...
     * @param string $commodityName
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ServiceOptionType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ServiceOptionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string[] $appliedOptions
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    public function setAppliedOptions(array $appliedOptions = array())
    {
        ...
        foreach ($appliedOptions as $commitDetailAppliedOptionsItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\ServiceOptionType::valueIsValid($commitDetailAppliedOptionsItem)) {
                $invalidValues[] = var_export($commitDetailAppliedOptionsItem);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ServiceOptionType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\ServiceOptionType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ServiceOptionType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ServiceSubOptionDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    public function setAppliedSubOptions(\NicholasCreativeMedia\FedExPHP\Rate\StructType\ServiceSubOptionDetail $appliedSubOptions = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    public function setDerivedShipmentSignatureOption(\NicholasCreativeMedia\FedExPHP\Rate\StructType\SignatureOptionDetail $derivedShipmentSignatureOption = null)
    {
    ...
    public function setDerivedPackageSignatureOptions(array $derivedPackageSignatureOptions = array())
    {
        foreach ($derivedPackageSignatureOptions as $commitDetailDerivedPackageSignatureOptionsItem) {
            ...
            if (!$commitDetailDerivedPackageSignatureOptionsItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\SignatureOptionDetail) {
                throw new \InvalidArgumentException(sprintf('The DerivedPackageSignatureOptions property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\SignatureOptionDetail, "%s" given', is_object($commitDetailDerivedPackageSignatureOptionsItem) ? get_class($commitDetailDerivedPackageSignatureOptionsItem) : gettype($commitDetailDerivedPackageSignatureOptionsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\SignatureOptionDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    public function addToDerivedPackageSignatureOptions(\NicholasCreativeMedia\FedExPHP\Rate\StructType\SignatureOptionDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\SignatureOptionDetail) {
            throw new \InvalidArgumentException(sprintf('The DerivedPackageSignatureOptions property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\SignatureOptionDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CleansedAddressAndLocationDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    public function setDerivedOriginDetail(\NicholasCreativeMedia\FedExPHP\Rate\StructType\CleansedAddressAndLocationDetail $derivedOriginDetail = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    public function setDerivedDestinationDetail(\NicholasCreativeMedia\FedExPHP\Rate\StructType\CleansedAddressAndLocationDetail $derivedDestinationDetail = null)
    {
    ...
    /**
     * Set DayOfWeek value
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $dayOfWeek
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::valueIsValid($dayOfWeek)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $dayOfWeek, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TransitTimeType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TransitTimeType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $transitTime
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\TransitTimeType::valueIsValid($transitTime)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $transitTime, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TransitTimeType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\TransitTimeType::valueIsValid($maximumTransitTime)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $maximumTransitTime, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TransitTimeType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    public function setBrokerAddress(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Address $brokerAddress = null)
    {
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::valueIsValid($brokerCommitDayOfWeek)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $brokerCommitDayOfWeek, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::valueIsValid($proofOfDeliveryDayOfWeek)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $proofOfDeliveryDayOfWeek, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\Notification[]|null
     */
    ...
    public function setCommitMessages(array $commitMessages = array())
    {
        foreach ($commitMessages as $commitDetailCommitMessagesItem) {
            // validation for constraint: itemType
            if (!$commitDetailCommitMessagesItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\Notification) {
                throw new \InvalidArgumentException(sprintf('The CommitMessages property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\Notification, "%s" given', is_object($commitDetailCommitMessagesItem) ? get_class($commitDetailCommitMessagesItem) : gettype($commitDetailCommitMessagesItem)), __LINE__);
            }
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    public function addToCommitMessages(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Notification $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\Notification) {
            throw new \InvalidArgumentException(sprintf('The CommitMessages property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\Notification, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\DelayDetail[]|null
     */
    ...
    public function setDelayDetails(array $delayDetails = array())
    {
        foreach ($delayDetails as $commitDetailDelayDetailsItem) {
            // validation for constraint: itemType
            if (!$commitDetailDelayDetailsItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\DelayDetail) {
                throw new \InvalidArgumentException(sprintf('The DelayDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\DelayDetail, "%s" given', is_object($commitDetailDelayDetailsItem) ? get_class($commitDetailDelayDetailsItem) : gettype($commitDetailDelayDetailsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\DelayDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    public function addToDelayDetails(\NicholasCreativeMedia\FedExPHP\Rate\StructType\DelayDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\DelayDetail) {
            throw new \InvalidArgumentException(sprintf('The DelayDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\DelayDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RequiredShippingDocumentType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RequiredShippingDocumentType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string[] $requiredDocuments
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    public function setRequiredDocuments(array $requiredDocuments = array())
    {
        ...
        foreach ($requiredDocuments as $commitDetailRequiredDocumentsItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\RequiredShippingDocumentType::valueIsValid($commitDetailRequiredDocumentsItem)) {
                $invalidValues[] = var_export($commitDetailRequiredDocumentsItem);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RequiredShippingDocumentType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\RequiredShippingDocumentType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RequiredShippingDocumentType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\FreightCommitDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail
     */
    public function setFreightCommitDetail(\NicholasCreativeMedia\FedExPHP\Rate\StructType\FreightCommitDetail $freightCommitDetail = null)
    {
