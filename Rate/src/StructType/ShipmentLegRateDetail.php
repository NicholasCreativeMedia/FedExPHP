...
class ShipmentLegRateDetail extends AbstractStructBase
{
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Address $legOrigin
     * @param string $legOriginLocationId
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Address $legDestination
     ...
     */
    public function __construct($legDescription = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Address $legOrigin = null, $legOriginLocationId = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Address $legDestination = null, $legDestinationLocationId = null, $rateType = null, $rateScale = null, $rateZone = null, $pricingCode = null, $ratedWeightMethod = null, $minimumChargeType = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\CurrencyExchangeRate $currencyExchangeRate = null, array $specialRatingApplied = array(), $dimDivisor = null, $dimDivisorType = null, $fuelSurchargePercent = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $totalBillingWeight = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $totalDimWeight = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalBaseCharge = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalFreightDiscounts = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalNetFreight = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalSurcharges = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalNetFedExCharge = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalTaxes = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalNetCharge = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalRebates = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalDutiesAndTaxes = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalNetChargeWithDutiesAndTaxes = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\FreightRateDetail $freightRateDetail = null, array $freightDiscounts = array(), array $rebates = array(), array $surcharges = array(), array $taxes = array(), array $dutiesAndTaxes = array(), \NicholasCreativeMedia\FedExPHP\Rate\StructType\VariableHandlingCharges $variableHandlingCharges = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\VariableHandlingCharges $totalVariableHandlingCharges = null)
    {
        $this
     ...
     * @param string $legDescription
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShipmentLegRateDetail
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShipmentLegRateDetail
     */
    public function setLegOrigin(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Address $legOrigin = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShipmentLegRateDetail
     */
    public function setLegDestination(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Address $legDestination = null)
    {
    ...
    public function setSpecialRatingApplied(array $specialRatingApplied = array())
    {
        ...
        foreach ($specialRatingApplied as $shipmentLegRateDetailSpecialRatingAppliedItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\SpecialRatingAppliedType::valueIsValid($shipmentLegRateDetailSpecialRatingAppliedItem)) {
    ...
    public function setFreightDiscounts(array $freightDiscounts = array())
    {
        foreach ($freightDiscounts as $shipmentLegRateDetailFreightDiscountsItem) {
            ...
            if (!$shipmentLegRateDetailFreightDiscountsItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateDiscount) {
                throw new \InvalidArgumentException(sprintf('The FreightDiscounts property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateDiscount, "%s" given', is_object($shipmentLegRateDetailFreightDiscountsItem) ? get_class($shipmentLegRateDetailFreightDiscountsItem) : gettype($shipmentLegRateDetailFreightDiscountsItem)), __LINE__);
            }
        }
    ...
    public function setRebates(array $rebates = array())
    {
        foreach ($rebates as $shipmentLegRateDetailRebatesItem) {
            // validation for constraint: itemType
            if (!$shipmentLegRateDetailRebatesItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\Rebate) {
                throw new \InvalidArgumentException(sprintf('The Rebates property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\Rebate, "%s" given', is_object($shipmentLegRateDetailRebatesItem) ? get_class($shipmentLegRateDetailRebatesItem) : gettype($shipmentLegRateDetailRebatesItem)), __LINE__);
            }
        }
    ...
    public function setSurcharges(array $surcharges = array())
    {
        foreach ($surcharges as $shipmentLegRateDetailSurchargesItem) {
            // validation for constraint: itemType
            if (!$shipmentLegRateDetailSurchargesItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\Surcharge) {
                throw new \InvalidArgumentException(sprintf('The Surcharges property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\Surcharge, "%s" given', is_object($shipmentLegRateDetailSurchargesItem) ? get_class($shipmentLegRateDetailSurchargesItem) : gettype($shipmentLegRateDetailSurchargesItem)), __LINE__);
            }
        }
    ...
    public function setTaxes(array $taxes = array())
    {
        foreach ($taxes as $shipmentLegRateDetailTaxesItem) {
            // validation for constraint: itemType
            if (!$shipmentLegRateDetailTaxesItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\Tax) {
                throw new \InvalidArgumentException(sprintf('The Taxes property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\Tax, "%s" given', is_object($shipmentLegRateDetailTaxesItem) ? get_class($shipmentLegRateDetailTaxesItem) : gettype($shipmentLegRateDetailTaxesItem)), __LINE__);
            }
        }
        $this->Taxes = $taxes;
        return $this;
    ...
    public function setDutiesAndTaxes(array $dutiesAndTaxes = array())
    {
        foreach ($dutiesAndTaxes as $shipmentLegRateDetailDutiesAndTaxesItem) {
            // validation for constraint: itemType
            if (!$shipmentLegRateDetailDutiesAndTaxesItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtCommodityTax) {
                throw new \InvalidArgumentException(sprintf('The DutiesAndTaxes property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtCommodityTax, "%s" given', is_object($shipmentLegRateDetailDutiesAndTaxesItem) ? get_class($shipmentLegRateDetailDutiesAndTaxesItem) : gettype($shipmentLegRateDetailDutiesAndTaxesItem)), __LINE__);
            }
        }
