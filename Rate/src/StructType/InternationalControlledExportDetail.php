...
class InternationalControlledExportDetail extends AbstractStructBase
{
    ...
    /**
     * Set Type value
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\InternationalControlledExportType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\InternationalControlledExportType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\InternationalControlledExportDetail
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\InternationalControlledExportType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\InternationalControlledExportType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
