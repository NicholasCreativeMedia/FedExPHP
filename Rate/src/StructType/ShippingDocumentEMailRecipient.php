...
class ShippingDocumentEMailRecipient extends AbstractStructBase
{
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\EMailNotificationRecipientType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\EMailNotificationRecipientType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $recipientType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentEMailRecipient
     */
    public function setRecipientType($recipientType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\EMailNotificationRecipientType::valueIsValid($recipientType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $recipientType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\EMailNotificationRecipientType::getValidValues())), __LINE__);
        }
