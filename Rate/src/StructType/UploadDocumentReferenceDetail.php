...
class UploadDocumentReferenceDetail extends AbstractStructBase
{
     ...
     * @param int $lineNumber
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentProducerType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentProducerType::getValidValues()
    ...
    public function setDocumentProducer($documentProducer = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentProducerType::valueIsValid($documentProducer)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $documentProducer, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentProducerType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $documentType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentType::valueIsValid($documentType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $documentType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentIdProducer::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentIdProducer::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $documentIdProducer
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentIdProducer::valueIsValid($documentIdProducer)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $documentIdProducer, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\UploadDocumentIdProducer::getValidValues())), __LINE__);
        }
