...
class RateRequest extends AbstractStructBase
{
     ...
     * - minOccurs: 1
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\WebAuthenticationDetail
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 1
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\ClientDetail
     */
    public $ClientDetail;
    /**
     * The Version
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConsolidationKey
     */
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\RequestedShipment
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\WebAuthenticationDetail $webAuthenticationDetail
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\ClientDetail $clientDetail
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConsolidationKey $consolidationKey
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\RequestedShipment $requestedShipment
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Rate\StructType\WebAuthenticationDetail $webAuthenticationDetail = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\ClientDetail $clientDetail = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\VersionId $version = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\TransactionDetail $transactionDetail = null, $returnTransitAndCommit = null, array $carrierCodes = array(), array $variableOptions = array(), \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConsolidationKey $consolidationKey = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\RequestedShipment $requestedShipment = null)
    {
        $this
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\WebAuthenticationDetail $webAuthenticationDetail
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateRequest
     */
    public function setWebAuthenticationDetail(\NicholasCreativeMedia\FedExPHP\Rate\StructType\WebAuthenticationDetail $webAuthenticationDetail = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ClientDetail
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateRequest
     */
    public function setClientDetail(\NicholasCreativeMedia\FedExPHP\Rate\StructType\ClientDetail $clientDetail = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\CarrierCodeType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\CarrierCodeType::getValidValues()
    ...
    public function setCarrierCodes(array $carrierCodes = array())
    {
        ...
        foreach ($carrierCodes as $rateRequestCarrierCodesItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\CarrierCodeType::valueIsValid($rateRequestCarrierCodesItem)) {
                $invalidValues[] = var_export($rateRequestCarrierCodesItem);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\CarrierCodeType::getValidValues())), __LINE__);
        }
    ...
    public function addToCarrierCodes($item)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\CarrierCodeType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\CarrierCodeType::getValidValues())), __LINE__);
        }
    ...
    public function setVariableOptions(array $variableOptions = array())
    {
        ...
        foreach ($variableOptions as $rateRequestVariableOptionsItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\ServiceOptionType::valueIsValid($rateRequestVariableOptionsItem)) {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConsolidationKey|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateRequest
     */
    public function setConsolidationKey(\NicholasCreativeMedia\FedExPHP\Rate\StructType\ConsolidationKey $consolidationKey = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\RequestedShipment|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateRequest
     */
    public function setRequestedShipment(\NicholasCreativeMedia\FedExPHP\Rate\StructType\RequestedShipment $requestedShipment = null)
    {
