...
class CommercialInvoice extends AbstractStructBase
{
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $freightCharge
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $taxesOrMiscellaneousCharge
     * @param string $taxesOrMiscellaneousChargeType
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $packingCosts
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $handlingCosts
     ...
     */
    public function __construct(array $comments = array(), \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $freightCharge = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $taxesOrMiscellaneousCharge = null, $taxesOrMiscellaneousChargeType = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $packingCosts = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $handlingCosts = null, $specialInstructions = null, $declarationStatement = null, $paymentTerms = null, $purpose = null, $originatorName = null, $termsOfSale = null)
    {
        $this
     ...
     * @param string[] $comments
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommercialInvoice
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommercialInvoice
     */
    public function setFreightCharge(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $freightCharge = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommercialInvoice
     */
    public function setTaxesOrMiscellaneousCharge(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $taxesOrMiscellaneousCharge = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TaxesOrMiscellaneousChargeType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TaxesOrMiscellaneousChargeType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $taxesOrMiscellaneousChargeType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommercialInvoice
     */
    public function setTaxesOrMiscellaneousChargeType($taxesOrMiscellaneousChargeType = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\TaxesOrMiscellaneousChargeType::valueIsValid($taxesOrMiscellaneousChargeType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $taxesOrMiscellaneousChargeType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TaxesOrMiscellaneousChargeType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommercialInvoice
     */
    public function setPackingCosts(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $packingCosts = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommercialInvoice
     */
    public function setHandlingCosts(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $handlingCosts = null)
    {
    ...
    /**
     * Set Purpose value
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PurposeOfShipmentType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PurposeOfShipmentType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $purpose
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommercialInvoice
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\PurposeOfShipmentType::valueIsValid($purpose)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $purpose, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PurposeOfShipmentType::getValidValues())), __LINE__);
        }
