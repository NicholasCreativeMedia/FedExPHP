...
class FreightAddressLabelDetail extends AbstractStructBase
{
     ...
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentFormat $format = null, $copies = null, $startingPosition = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\DocTabContent $docTabContent = null, $customContentPosition = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomLabelDetail $customContent = null)
    {
        $this
            ->setFormat($format)
            ->setCopies($copies)
     ...
     * Set Format value
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentFormat $format
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\FreightAddressLabelDetail
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PageQuadrantType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PageQuadrantType::getValidValues()
    ...
    public function setStartingPosition($startingPosition = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\PageQuadrantType::valueIsValid($startingPosition)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $startingPosition, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PageQuadrantType::getValidValues())), __LINE__);
        }
