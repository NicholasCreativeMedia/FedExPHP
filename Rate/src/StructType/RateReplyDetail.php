...
class RateReplyDetail extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\RatedShipmentDetail[]
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail[] $commitDetails
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\RatedShipmentDetail[] $ratedShipmentDetails
     */
    public function __construct($serviceType = null, $packagingType = null, array $appliedOptions = array(), \NicholasCreativeMedia\FedExPHP\Rate\StructType\ServiceSubOptionDetail $appliedSubOptions = null, $deliveryStation = null, $deliveryDayOfWeek = null, $deliveryTimestamp = null, array $commitDetails = array(), $destinationAirportId = null, $ineligibleForMoneyBackGuarantee = null, $originServiceArea = null, $destinationServiceArea = null, $transitTime = null, $maximumTransitTime = null, $signatureOption = null, $actualRateType = null, array $ratedShipmentDetails = array())
    {
        $this
     ...
     * @param string $serviceType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateReplyDetail
     */
    ...
    public function setAppliedOptions(array $appliedOptions = array())
    {
        ...
        foreach ($appliedOptions as $rateReplyDetailAppliedOptionsItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\ServiceOptionType::valueIsValid($rateReplyDetailAppliedOptionsItem)) {
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::valueIsValid($deliveryDayOfWeek)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $deliveryDayOfWeek, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail[]|null
     */
    ...
    public function setCommitDetails(array $commitDetails = array())
    {
        foreach ($commitDetails as $rateReplyDetailCommitDetailsItem) {
            ...
            if (!$rateReplyDetailCommitDetailsItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail) {
                throw new \InvalidArgumentException(sprintf('The CommitDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail, "%s" given', is_object($rateReplyDetailCommitDetailsItem) ? get_class($rateReplyDetailCommitDetailsItem) : gettype($rateReplyDetailCommitDetailsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateReplyDetail
     */
    public function addToCommitDetails(\NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail) {
            throw new \InvalidArgumentException(sprintf('The CommitDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\CommitDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\SignatureOptionType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\SignatureOptionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $signatureOption
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateReplyDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\SignatureOptionType::valueIsValid($signatureOption)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $signatureOption, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\SignatureOptionType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\ReturnedRateType::valueIsValid($actualRateType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $actualRateType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ReturnedRateType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\RatedShipmentDetail[]|null
     */
    ...
    public function setRatedShipmentDetails(array $ratedShipmentDetails = array())
    {
        foreach ($ratedShipmentDetails as $rateReplyDetailRatedShipmentDetailsItem) {
            // validation for constraint: itemType
            if (!$rateReplyDetailRatedShipmentDetailsItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\RatedShipmentDetail) {
                throw new \InvalidArgumentException(sprintf('The RatedShipmentDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\RatedShipmentDetail, "%s" given', is_object($rateReplyDetailRatedShipmentDetailsItem) ? get_class($rateReplyDetailRatedShipmentDetailsItem) : gettype($rateReplyDetailRatedShipmentDetailsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\RatedShipmentDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateReplyDetail
     */
    public function addToRatedShipmentDetails(\NicholasCreativeMedia\FedExPHP\Rate\StructType\RatedShipmentDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\RatedShipmentDetail) {
            throw new \InvalidArgumentException(sprintf('The RatedShipmentDetails property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\RatedShipmentDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
