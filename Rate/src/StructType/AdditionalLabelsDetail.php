...
class AdditionalLabelsDetail extends AbstractStructBase
{
    ...
    /**
     * Set Type value
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\AdditionalLabelsType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\AdditionalLabelsType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\AdditionalLabelsDetail
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\AdditionalLabelsType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\AdditionalLabelsType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
