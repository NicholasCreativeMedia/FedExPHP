...
class PickupDetail extends AbstractStructBase
{
     ...
     * @param string $readyDateTime
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\PickupDetail
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PickupRequestType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PickupRequestType::getValidValues()
    ...
    public function setRequestType($requestType = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\PickupRequestType::valueIsValid($requestType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $requestType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PickupRequestType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PickupRequestSourceType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PickupRequestSourceType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $requestSource
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\PickupDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\PickupRequestSourceType::valueIsValid($requestSource)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $requestSource, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\PickupRequestSourceType::getValidValues())), __LINE__);
        }
