...
class ContactAndAddress extends AbstractStructBase
{
     ...
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Contact $contact = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Address $address = null)
    {
        $this
            ->setContact($contact)
            ->setAddress($address);
     ...
     * Set Contact value
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Contact $contact
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ContactAndAddress
     */
