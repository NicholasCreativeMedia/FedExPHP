...
class TaxpayerIdentification extends AbstractStructBase
{
    ...
    /**
     * Set TinType value
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TinType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TinType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $tinType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\TaxpayerIdentification
     */
    public function setTinType($tinType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\TinType::valueIsValid($tinType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $tinType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TinType::getValidValues())), __LINE__);
        }
