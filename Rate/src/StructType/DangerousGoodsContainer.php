...
class DangerousGoodsContainer extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityContent[]
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityContent[] $hazardousCommodities
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousContainerPackingType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousContainerPackingType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $packingType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\DangerousGoodsContainer
     */
    public function setPackingType($packingType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousContainerPackingType::valueIsValid($packingType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $packingType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousContainerPackingType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RadioactiveContainerClassType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RadioactiveContainerClassType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $radioactiveContainerClass
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\DangerousGoodsContainer
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\RadioactiveContainerClassType::valueIsValid($radioactiveContainerClass)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $radioactiveContainerClass, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RadioactiveContainerClassType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityContent[]|null
     */
    ...
    public function setHazardousCommodities(array $hazardousCommodities = array())
    {
        foreach ($hazardousCommodities as $dangerousGoodsContainerHazardousCommoditiesItem) {
            ...
            if (!$dangerousGoodsContainerHazardousCommoditiesItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityContent) {
                throw new \InvalidArgumentException(sprintf('The HazardousCommodities property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityContent, "%s" given', is_object($dangerousGoodsContainerHazardousCommoditiesItem) ? get_class($dangerousGoodsContainerHazardousCommoditiesItem) : gettype($dangerousGoodsContainerHazardousCommoditiesItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityContent $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\DangerousGoodsContainer
     */
    public function addToHazardousCommodities(\NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityContent $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityContent) {
            throw new \InvalidArgumentException(sprintf('The HazardousCommodities property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityContent, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
