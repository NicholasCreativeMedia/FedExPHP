...
class FreightServiceCenterDetail extends AbstractStructBase
{
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Distance $localDistance
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\ContactAndAddress $contactAndAddress
     */
    public function __construct($interlineCarrierCode = null, $interlineCarrierName = null, $additionalDays = null, $localService = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Distance $localDistance = null, $localDuration = null, $localServiceScheduling = null, array $limitedServiceDays = array(), $gatewayLocationId = null, $location = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\ContactAndAddress $contactAndAddress = null)
    {
        $this
     ...
     * @param string $interlineCarrierCode
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\FreightServiceCenterDetail
     */
    ...
    public function setLocalService($localService = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\ServiceType::valueIsValid($localService)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $localService, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ServiceType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\FreightServiceCenterDetail
     */
    public function setLocalDistance(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Distance $localDistance = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\FreightServiceSchedulingType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\FreightServiceSchedulingType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $localServiceScheduling
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\FreightServiceCenterDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\FreightServiceSchedulingType::valueIsValid($localServiceScheduling)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $localServiceScheduling, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\FreightServiceSchedulingType::getValidValues())), __LINE__);
        }
    ...
    public function setLimitedServiceDays(array $limitedServiceDays = array())
    {
        ...
        foreach ($limitedServiceDays as $freightServiceCenterDetailLimitedServiceDaysItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::valueIsValid($freightServiceCenterDetailLimitedServiceDaysItem)) {
                $invalidValues[] = var_export($freightServiceCenterDetailLimitedServiceDaysItem);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\DayOfWeekType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\FreightServiceCenterDetail
     */
    public function setContactAndAddress(\NicholasCreativeMedia\FedExPHP\Rate\StructType\ContactAndAddress $contactAndAddress = null)
    {
