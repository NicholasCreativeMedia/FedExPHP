...
class EtdDetail extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail[]
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail[] $documentReferences
     */
     ...
     * @param string[] $requestedDocumentCopies
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\EtdDetail
     */
    public function setRequestedDocumentCopies(array $requestedDocumentCopies = array())
    {
        ...
        foreach ($requestedDocumentCopies as $etdDetailRequestedDocumentCopiesItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\RequestedShippingDocumentType::valueIsValid($etdDetailRequestedDocumentCopiesItem)) {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail[]|null
     */
    ...
    public function setDocumentReferences(array $documentReferences = array())
    {
        foreach ($documentReferences as $etdDetailDocumentReferencesItem) {
            ...
            if (!$etdDetailDocumentReferencesItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail) {
                throw new \InvalidArgumentException(sprintf('The DocumentReferences property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail, "%s" given', is_object($etdDetailDocumentReferencesItem) ? get_class($etdDetailDocumentReferencesItem) : gettype($etdDetailDocumentReferencesItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\EtdDetail
     */
    public function addToDocumentReferences(\NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail) {
            throw new \InvalidArgumentException(sprintf('The DocumentReferences property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\UploadDocumentReferenceDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
