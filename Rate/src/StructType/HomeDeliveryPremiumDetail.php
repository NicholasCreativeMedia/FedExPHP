...
class HomeDeliveryPremiumDetail extends AbstractStructBase
{
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HomeDeliveryPremiumType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HomeDeliveryPremiumType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $homeDeliveryPremiumType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\HomeDeliveryPremiumDetail
     */
    public function setHomeDeliveryPremiumType($homeDeliveryPremiumType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\HomeDeliveryPremiumType::valueIsValid($homeDeliveryPremiumType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $homeDeliveryPremiumType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HomeDeliveryPremiumType::getValidValues())), __LINE__);
        }
