...
class DocTabZoneSpecification extends AbstractStructBase
{
     ...
     * @param int $zoneNumber
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\DocTabZoneSpecification
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\DocTabZoneJustificationType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\DocTabZoneJustificationType::getValidValues()
    ...
    public function setJustification($justification = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\DocTabZoneJustificationType::valueIsValid($justification)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $justification, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\DocTabZoneJustificationType::getValidValues())), __LINE__);
        }
