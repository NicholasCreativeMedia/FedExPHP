...
class CustomerSpecifiedLabelDetail extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\DocTabContent
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConfigurableLabelReferenceEntry[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\RegulatoryLabelContentDetail[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\AdditionalLabelsDetail[]
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\DocTabContent $docTabContent
     * @param string $customContentPosition
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomLabelDetail $customContent
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConfigurableLabelReferenceEntry[] $configurableReferenceEntries
     * @param string[] $maskedData
     * @param string $secondaryBarcode
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Localization $termsAndConditionsLocalization
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\RegulatoryLabelContentDetail[] $regulatoryLabels
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\AdditionalLabelsDetail[] $additionalLabels
     * @param int $airWaybillSuppressionCount
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Rate\StructType\DocTabContent $docTabContent = null, $customContentPosition = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomLabelDetail $customContent = null, array $configurableReferenceEntries = array(), array $maskedData = array(), $secondaryBarcode = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Localization $termsAndConditionsLocalization = null, array $regulatoryLabels = array(), array $additionalLabels = array(), $airWaybillSuppressionCount = null)
    {
        $this
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\DocTabContent|null
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\DocTabContent $docTabContent
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomerSpecifiedLabelDetail
     */
    public function setDocTabContent(\NicholasCreativeMedia\FedExPHP\Rate\StructType\DocTabContent $docTabContent = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RelativeVerticalPositionType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RelativeVerticalPositionType::getValidValues()
    ...
    public function setCustomContentPosition($customContentPosition = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\RelativeVerticalPositionType::valueIsValid($customContentPosition)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $customContentPosition, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RelativeVerticalPositionType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConfigurableLabelReferenceEntry[]|null
     */
    ...
    public function setConfigurableReferenceEntries(array $configurableReferenceEntries = array())
    {
        foreach ($configurableReferenceEntries as $customerSpecifiedLabelDetailConfigurableReferenceEntriesItem) {
            ...
            if (!$customerSpecifiedLabelDetailConfigurableReferenceEntriesItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConfigurableLabelReferenceEntry) {
                throw new \InvalidArgumentException(sprintf('The ConfigurableReferenceEntries property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConfigurableLabelReferenceEntry, "%s" given', is_object($customerSpecifiedLabelDetailConfigurableReferenceEntriesItem) ? get_class($customerSpecifiedLabelDetailConfigurableReferenceEntriesItem) : gettype($customerSpecifiedLabelDetailConfigurableReferenceEntriesItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConfigurableLabelReferenceEntry $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomerSpecifiedLabelDetail
     */
    public function addToConfigurableReferenceEntries(\NicholasCreativeMedia\FedExPHP\Rate\StructType\ConfigurableLabelReferenceEntry $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConfigurableLabelReferenceEntry) {
            throw new \InvalidArgumentException(sprintf('The ConfigurableReferenceEntries property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\ConfigurableLabelReferenceEntry, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\LabelMaskableDataType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\LabelMaskableDataType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string[] $maskedData
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomerSpecifiedLabelDetail
     */
    public function setMaskedData(array $maskedData = array())
    {
        ...
        foreach ($maskedData as $customerSpecifiedLabelDetailMaskedDataItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\LabelMaskableDataType::valueIsValid($customerSpecifiedLabelDetailMaskedDataItem)) {
                $invalidValues[] = var_export($customerSpecifiedLabelDetailMaskedDataItem);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\LabelMaskableDataType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\LabelMaskableDataType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\LabelMaskableDataType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\SecondaryBarcodeType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\SecondaryBarcodeType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $secondaryBarcode
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomerSpecifiedLabelDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\SecondaryBarcodeType::valueIsValid($secondaryBarcode)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $secondaryBarcode, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\SecondaryBarcodeType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomerSpecifiedLabelDetail
     */
    public function setTermsAndConditionsLocalization(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Localization $termsAndConditionsLocalization = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\RegulatoryLabelContentDetail[]|null
     */
    ...
    public function setRegulatoryLabels(array $regulatoryLabels = array())
    {
        foreach ($regulatoryLabels as $customerSpecifiedLabelDetailRegulatoryLabelsItem) {
            // validation for constraint: itemType
            if (!$customerSpecifiedLabelDetailRegulatoryLabelsItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\RegulatoryLabelContentDetail) {
                throw new \InvalidArgumentException(sprintf('The RegulatoryLabels property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\RegulatoryLabelContentDetail, "%s" given', is_object($customerSpecifiedLabelDetailRegulatoryLabelsItem) ? get_class($customerSpecifiedLabelDetailRegulatoryLabelsItem) : gettype($customerSpecifiedLabelDetailRegulatoryLabelsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\RegulatoryLabelContentDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomerSpecifiedLabelDetail
     */
    public function addToRegulatoryLabels(\NicholasCreativeMedia\FedExPHP\Rate\StructType\RegulatoryLabelContentDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\RegulatoryLabelContentDetail) {
            throw new \InvalidArgumentException(sprintf('The RegulatoryLabels property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\RegulatoryLabelContentDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\AdditionalLabelsDetail[]|null
     */
    ...
    public function setAdditionalLabels(array $additionalLabels = array())
    {
        foreach ($additionalLabels as $customerSpecifiedLabelDetailAdditionalLabelsItem) {
            // validation for constraint: itemType
            if (!$customerSpecifiedLabelDetailAdditionalLabelsItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\AdditionalLabelsDetail) {
                throw new \InvalidArgumentException(sprintf('The AdditionalLabels property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\AdditionalLabelsDetail, "%s" given', is_object($customerSpecifiedLabelDetailAdditionalLabelsItem) ? get_class($customerSpecifiedLabelDetailAdditionalLabelsItem) : gettype($customerSpecifiedLabelDetailAdditionalLabelsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\AdditionalLabelsDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomerSpecifiedLabelDetail
     */
    public function addToAdditionalLabels(\NicholasCreativeMedia\FedExPHP\Rate\StructType\AdditionalLabelsDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\AdditionalLabelsDetail) {
            throw new \InvalidArgumentException(sprintf('The AdditionalLabels property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\AdditionalLabelsDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
