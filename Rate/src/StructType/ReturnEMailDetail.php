...
class ReturnEMailDetail extends AbstractStructBase
{
     ...
     * @param string $merchantPhoneNumber
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ReturnEMailDetail
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ReturnEMailAllowedSpecialServiceType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ReturnEMailAllowedSpecialServiceType::getValidValues()
    ...
    public function setAllowedSpecialServices(array $allowedSpecialServices = array())
    {
        ...
        foreach ($allowedSpecialServices as $returnEMailDetailAllowedSpecialServicesItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\ReturnEMailAllowedSpecialServiceType::valueIsValid($returnEMailDetailAllowedSpecialServicesItem)) {
                $invalidValues[] = var_export($returnEMailDetailAllowedSpecialServicesItem);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ReturnEMailAllowedSpecialServiceType::getValidValues())), __LINE__);
        }
    ...
    public function addToAllowedSpecialServices($item)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\ReturnEMailAllowedSpecialServiceType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ReturnEMailAllowedSpecialServiceType::getValidValues())), __LINE__);
        }
