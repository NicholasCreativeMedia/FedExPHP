...
class HazardousCommodityQuantityDetail extends AbstractStructBase
{
     ...
     * Set Amount value
     * @param float $amount
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityQuantityDetail
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousCommodityQuantityType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousCommodityQuantityType::getValidValues()
    ...
    public function setQuantityType($quantityType = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousCommodityQuantityType::valueIsValid($quantityType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $quantityType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousCommodityQuantityType::getValidValues())), __LINE__);
        }
