...
class TrackingId extends AbstractStructBase
{
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TrackingIdType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TrackingIdType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $trackingIdType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\TrackingId
     */
    public function setTrackingIdType($trackingIdType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\TrackingIdType::valueIsValid($trackingIdType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $trackingIdType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\TrackingIdType::getValidValues())), __LINE__);
        }
