...
class ShippingDocumentFormat extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentDispositionDetail[]
     */
    public $Dispositions;
    /**
     * The TopOfPageOffset
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\LinearMeasure
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\DocumentFormatOptionsRequested
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentDispositionDetail[] $dispositions
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\LinearMeasure $topOfPageOffset
     * @param string $imageType
     * @param string $stockType
     * @param bool $provideInstructions
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\DocumentFormatOptionsRequested $optionsRequested
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Localization $localization
     */
    public function __construct(array $dispositions = array(), \NicholasCreativeMedia\FedExPHP\Rate\StructType\LinearMeasure $topOfPageOffset = null, $imageType = null, $stockType = null, $provideInstructions = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\DocumentFormatOptionsRequested $optionsRequested = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Localization $localization = null)
    {
        $this
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentDispositionDetail[]|null
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentDispositionDetail[] $dispositions
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentFormat
     */
    public function setDispositions(array $dispositions = array())
    {
        foreach ($dispositions as $shippingDocumentFormatDispositionsItem) {
            ...
            if (!$shippingDocumentFormatDispositionsItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentDispositionDetail) {
                throw new \InvalidArgumentException(sprintf('The Dispositions property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentDispositionDetail, "%s" given', is_object($shippingDocumentFormatDispositionsItem) ? get_class($shippingDocumentFormatDispositionsItem) : gettype($shippingDocumentFormatDispositionsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentDispositionDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentFormat
     */
    public function addToDispositions(\NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentDispositionDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentDispositionDetail) {
            throw new \InvalidArgumentException(sprintf('The Dispositions property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentDispositionDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\LinearMeasure|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentFormat
     */
    public function setTopOfPageOffset(\NicholasCreativeMedia\FedExPHP\Rate\StructType\LinearMeasure $topOfPageOffset = null)
    {
    ...
    /**
     * Set StockType value
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ShippingDocumentStockType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ShippingDocumentStockType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $stockType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentFormat
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\ShippingDocumentStockType::valueIsValid($stockType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $stockType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ShippingDocumentStockType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\DocumentFormatOptionsRequested|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ShippingDocumentFormat
     */
    public function setOptionsRequested(\NicholasCreativeMedia\FedExPHP\Rate\StructType\DocumentFormatOptionsRequested $optionsRequested = null)
    {
