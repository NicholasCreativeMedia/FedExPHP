...
class PackageRateDetail extends AbstractStructBase
{
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $billingWeight
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $dimWeight
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $oversizeWeight
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $baseCharge
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalFreightDiscounts
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $netFreight
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalSurcharges
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $netFedExCharge
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalTaxes
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $netCharge
     ...
     */
    public function __construct($rateType = null, $ratedWeightMethod = null, $minimumChargeType = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $billingWeight = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $dimWeight = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $oversizeWeight = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $baseCharge = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalFreightDiscounts = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $netFreight = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalSurcharges = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $netFedExCharge = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalTaxes = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $netCharge = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $totalRebates = null, array $freightDiscounts = array(), array $rebates = array(), array $surcharges = array(), array $taxes = array(), \NicholasCreativeMedia\FedExPHP\Rate\StructType\VariableHandlingCharges $variableHandlingCharges = null)
    {
        $this
     ...
     * @param string $rateType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\PackageRateDetail
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\PackageRateDetail
     */
    public function setBillingWeight(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $billingWeight = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\PackageRateDetail
     */
    public function setDimWeight(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $dimWeight = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\PackageRateDetail
     */
    public function setOversizeWeight(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $oversizeWeight = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\PackageRateDetail
     */
    public function setBaseCharge(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $baseCharge = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\PackageRateDetail
     */
    public function setNetFreight(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $netFreight = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\PackageRateDetail
     */
    public function setNetFedExCharge(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $netFedExCharge = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\PackageRateDetail
     */
    public function setNetCharge(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $netCharge = null)
    {
    ...
    public function setFreightDiscounts(array $freightDiscounts = array())
    {
        foreach ($freightDiscounts as $packageRateDetailFreightDiscountsItem) {
            ...
            if (!$packageRateDetailFreightDiscountsItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateDiscount) {
                throw new \InvalidArgumentException(sprintf('The FreightDiscounts property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\RateDiscount, "%s" given', is_object($packageRateDetailFreightDiscountsItem) ? get_class($packageRateDetailFreightDiscountsItem) : gettype($packageRateDetailFreightDiscountsItem)), __LINE__);
            }
        }
    ...
    public function setRebates(array $rebates = array())
    {
        foreach ($rebates as $packageRateDetailRebatesItem) {
            // validation for constraint: itemType
            if (!$packageRateDetailRebatesItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\Rebate) {
                throw new \InvalidArgumentException(sprintf('The Rebates property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\Rebate, "%s" given', is_object($packageRateDetailRebatesItem) ? get_class($packageRateDetailRebatesItem) : gettype($packageRateDetailRebatesItem)), __LINE__);
            }
        }
    ...
    public function setSurcharges(array $surcharges = array())
    {
        foreach ($surcharges as $packageRateDetailSurchargesItem) {
            // validation for constraint: itemType
            if (!$packageRateDetailSurchargesItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\Surcharge) {
                throw new \InvalidArgumentException(sprintf('The Surcharges property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\Surcharge, "%s" given', is_object($packageRateDetailSurchargesItem) ? get_class($packageRateDetailSurchargesItem) : gettype($packageRateDetailSurchargesItem)), __LINE__);
            }
        }
    ...
    public function setTaxes(array $taxes = array())
    {
        foreach ($taxes as $packageRateDetailTaxesItem) {
            // validation for constraint: itemType
            if (!$packageRateDetailTaxesItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\Tax) {
                throw new \InvalidArgumentException(sprintf('The Taxes property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\Tax, "%s" given', is_object($packageRateDetailTaxesItem) ? get_class($packageRateDetailTaxesItem) : gettype($packageRateDetailTaxesItem)), __LINE__);
            }
        }
        $this->Taxes = $taxes;
        return $this;
