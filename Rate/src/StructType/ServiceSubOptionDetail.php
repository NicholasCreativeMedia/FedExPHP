...
class ServiceSubOptionDetail extends AbstractStructBase
{
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\FreightGuaranteeType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\FreightGuaranteeType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $freightGuarantee
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\ServiceSubOptionDetail
     */
    public function setFreightGuarantee($freightGuarantee = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\FreightGuaranteeType::valueIsValid($freightGuarantee)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $freightGuarantee, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\FreightGuaranteeType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\SmartPostIndiciaType::valueIsValid($smartPostIndicia)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $smartPostIndicia, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\SmartPostIndiciaType::getValidValues())), __LINE__);
        }
