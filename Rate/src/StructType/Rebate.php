...
class Rebate extends AbstractStructBase
{
     ...
     * @param float $percent
     */
    public function __construct($rebateType = null, $description = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $amount = null, $percent = null)
    {
        $this
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RebateType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RebateType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $rebateType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\Rebate
     */
    public function setRebateType($rebateType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\RebateType::valueIsValid($rebateType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $rebateType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\RebateType::getValidValues())), __LINE__);
        }
