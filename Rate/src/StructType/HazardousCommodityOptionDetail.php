...
class HazardousCommodityOptionDetail extends AbstractStructBase
{
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousCommodityLabelTextOptionType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousCommodityLabelTextOptionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $labelTextOption
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityOptionDetail
     */
    public function setLabelTextOption($labelTextOption = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousCommodityLabelTextOptionType::valueIsValid($labelTextOption)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $labelTextOption, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\HazardousCommodityLabelTextOptionType::getValidValues())), __LINE__);
        }
