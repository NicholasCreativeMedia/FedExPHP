...
class Notification extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\NotificationParameter[]
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\NotificationParameter[] $messageParameters
     */
    ...
    public function setSeverity($severity = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\NotificationSeverityType::valueIsValid($severity)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $severity, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\NotificationSeverityType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\NotificationParameter[]|null
     */
    ...
    public function setMessageParameters(array $messageParameters = array())
    {
        foreach ($messageParameters as $notificationMessageParametersItem) {
            ...
            if (!$notificationMessageParametersItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\NotificationParameter) {
                throw new \InvalidArgumentException(sprintf('The MessageParameters property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\NotificationParameter, "%s" given', is_object($notificationMessageParametersItem) ? get_class($notificationMessageParametersItem) : gettype($notificationMessageParametersItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\NotificationParameter $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\Notification
     */
    public function addToMessageParameters(\NicholasCreativeMedia\FedExPHP\Rate\StructType\NotificationParameter $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\NotificationParameter) {
            throw new \InvalidArgumentException(sprintf('The MessageParameters property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\NotificationParameter, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
