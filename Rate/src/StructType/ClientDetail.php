...
class ClientDetail extends AbstractStructBase
{
     ...
     */
    public function __construct($accountNumber = null, $meterNumber = null, $integratorId = null, $region = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Localization $localization = null)
    {
        $this
    ...
    /**
     * Set Region value
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ExpressRegionCode::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ExpressRegionCode::getValidValues()
    ...
    public function setRegion($region = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\ExpressRegionCode::valueIsValid($region)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $region, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\ExpressRegionCode::getValidValues())), __LINE__);
        }
        $this->Region = $region;
        return $this;
    }
