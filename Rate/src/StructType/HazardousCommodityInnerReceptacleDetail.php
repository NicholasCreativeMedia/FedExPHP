...
class HazardousCommodityInnerReceptacleDetail extends AbstractStructBase
{
     ...
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityQuantityDetail $quantity = null)
    {
        $this
     ...
     * Set Quantity value
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityQuantityDetail $quantity
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\HazardousCommodityInnerReceptacleDetail
     */
