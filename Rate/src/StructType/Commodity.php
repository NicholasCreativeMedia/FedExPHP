...
class Commodity extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\Measure[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtExciseCondition[]
     */
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Rate\StructType\NaftaCommodityDetail
     */
    public $NaftaDetail;
    /**
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Measure[] $additionalMeasures
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $unitPrice
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $customsValue
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtExciseCondition[] $exciseConditions
     * @param string $exportLicenseNumber
     * @param string $exportLicenseExpirationDate
     * @param string $cIMarksAndNumbers
     * @param string $partNumber
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\NaftaCommodityDetail $naftaDetail
     */
    public function __construct($name = null, $numberOfPieces = null, $description = null, $purpose = null, $countryOfManufacture = null, $harmonizedCode = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Weight $weight = null, $quantity = null, $quantityUnits = null, array $additionalMeasures = array(), \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $unitPrice = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $customsValue = null, array $exciseConditions = array(), $exportLicenseNumber = null, $exportLicenseExpirationDate = null, $cIMarksAndNumbers = null, $partNumber = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\NaftaCommodityDetail $naftaDetail = null)
    {
        $this
            ->setName($name)
     ...
     * Set Name value
     * @param string $name
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\Commodity
     */
    ...
    /**
     * Set Purpose value
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\CommodityPurposeType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\CommodityPurposeType::getValidValues()
    ...
    public function setPurpose($purpose = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\CommodityPurposeType::valueIsValid($purpose)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $purpose, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\CommodityPurposeType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\Measure[]|null
     */
    ...
    public function setAdditionalMeasures(array $additionalMeasures = array())
    {
        foreach ($additionalMeasures as $commodityAdditionalMeasuresItem) {
            ...
            if (!$commodityAdditionalMeasuresItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\Measure) {
                throw new \InvalidArgumentException(sprintf('The AdditionalMeasures property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\Measure, "%s" given', is_object($commodityAdditionalMeasuresItem) ? get_class($commodityAdditionalMeasuresItem) : gettype($commodityAdditionalMeasuresItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Measure $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\Commodity
     */
    public function addToAdditionalMeasures(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Measure $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\Measure) {
            throw new \InvalidArgumentException(sprintf('The AdditionalMeasures property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\Measure, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\Commodity
     */
    public function setUnitPrice(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $unitPrice = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtExciseCondition[]|null
     */
    ...
    public function setExciseConditions(array $exciseConditions = array())
    {
        foreach ($exciseConditions as $commodityExciseConditionsItem) {
            // validation for constraint: itemType
            if (!$commodityExciseConditionsItem instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtExciseCondition) {
                throw new \InvalidArgumentException(sprintf('The ExciseConditions property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtExciseCondition, "%s" given', is_object($commodityExciseConditionsItem) ? get_class($commodityExciseConditionsItem) : gettype($commodityExciseConditionsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtExciseCondition $item
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\Commodity
     */
    public function addToExciseConditions(\NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtExciseCondition $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtExciseCondition) {
            throw new \InvalidArgumentException(sprintf('The ExciseConditions property can only contain items of \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtExciseCondition, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\NaftaCommodityDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\Commodity
     */
    public function setNaftaDetail(\NicholasCreativeMedia\FedExPHP\Rate\StructType\NaftaCommodityDetail $naftaDetail = null)
    {
