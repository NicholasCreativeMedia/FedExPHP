...
class CustomLabelGraphicEntry extends AbstractStructBase
{
     ...
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomLabelPosition $position = null, $printerGraphicId = null, $fileGraphicFullName = null)
    {
        $this
     ...
     * Set Position value
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomLabelPosition $position
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\CustomLabelGraphicEntry
     */
