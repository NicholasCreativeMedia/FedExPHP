...
class EdtTaxDetail extends AbstractStructBase
{
     ...
     * @param string $name
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $taxableValue
     * @param string $description
     * @param string $formula
     * @param \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $amount
     */
    public function __construct($taxType = null, $effectiveDate = null, $name = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $taxableValue = null, $description = null, $formula = null, \NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $amount = null)
    {
        $this
            ->setTaxType($taxType)
    ...
    /**
     * Set TaxType value
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\EdtTaxType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Rate\EnumType\EdtTaxType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $taxType
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtTaxDetail
     */
    public function setTaxType($taxType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Rate\EnumType\EdtTaxType::valueIsValid($taxType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $taxType, implode(', ', \NicholasCreativeMedia\FedExPHP\Rate\EnumType\EdtTaxType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Rate\StructType\EdtTaxDetail
     */
    public function setTaxableValue(\NicholasCreativeMedia\FedExPHP\Rate\StructType\Money $taxableValue = null)
    {
