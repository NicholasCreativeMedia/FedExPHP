...
class PackageOperationalDetail extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\OperationalInstruction[]
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\OperationalInstruction[] $operationalInstructions
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\PackageBarcodes $barcodes
     * @param string $groundServiceCode
     */
    public function __construct($astraHandlingText = null, array $operationalInstructions = array(), \NicholasCreativeMedia\FedExPHP\Ship\StructType\PackageBarcodes $barcodes = null, $groundServiceCode = null)
    {
        $this
     ...
     * @param string $astraHandlingText
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\PackageOperationalDetail
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\OperationalInstruction[]|null
     */
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\OperationalInstruction $item
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\PackageOperationalDetail
     */
    public function addToOperationalInstructions(\NicholasCreativeMedia\FedExPHP\Ship\StructType\OperationalInstruction $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\OperationalInstruction) {
            throw new \InvalidArgumentException(sprintf('The OperationalInstructions property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\OperationalInstruction, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
