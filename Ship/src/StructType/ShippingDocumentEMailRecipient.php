...
class ShippingDocumentEMailRecipient extends AbstractStructBase
{
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\EMailNotificationRecipientType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\EMailNotificationRecipientType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $recipientType
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentEMailRecipient
     */
    public function setRecipientType($recipientType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\EMailNotificationRecipientType::valueIsValid($recipientType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $recipientType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\EMailNotificationRecipientType::getValidValues())), __LINE__);
        }
