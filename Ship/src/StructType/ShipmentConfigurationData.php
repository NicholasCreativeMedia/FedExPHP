...
class ShipmentConfigurationData extends AbstractStructBase
{
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail[] $dangerousGoodsPackageConfigurations
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail[] $dangerousGoodsPackageConfigurations
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentConfigurationData
     */
    public function setDangerousGoodsPackageConfigurations(array $dangerousGoodsPackageConfigurations = array())
    {
        foreach ($dangerousGoodsPackageConfigurations as $shipmentConfigurationDataDangerousGoodsPackageConfigurationsItem) {
            ...
            if (!$shipmentConfigurationDataDangerousGoodsPackageConfigurationsItem instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail) {
                throw new \InvalidArgumentException(sprintf('The DangerousGoodsPackageConfigurations property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail, "%s" given', is_object($shipmentConfigurationDataDangerousGoodsPackageConfigurationsItem) ? get_class($shipmentConfigurationDataDangerousGoodsPackageConfigurationsItem) : gettype($shipmentConfigurationDataDangerousGoodsPackageConfigurationsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail $item
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentConfigurationData
     */
    public function addToDangerousGoodsPackageConfigurations(\NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail) {
            throw new \InvalidArgumentException(sprintf('The DangerousGoodsPackageConfigurations property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
