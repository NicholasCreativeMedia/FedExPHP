...
class TransactionDetail extends AbstractStructBase
{
     ...
     */
    public function __construct($customerTransactionId = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Localization $localization = null)
    {
        $this
     ...
     * @param string $customerTransactionId
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\TransactionDetail
     */
