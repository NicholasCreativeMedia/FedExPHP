...
class NaftaCertificateOfOriginDetail extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\DateRange
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaProducer[]
     */
    public $Producers;
    /**
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\DateRange $blanketPeriod
     * @param string $importerSpecification
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Contact $signatureContact
     * @param string $producerSpecification
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaProducer[] $producers
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomerImageUsage[] $customerImageUsages
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentFormat $format = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\DateRange $blanketPeriod = null, $importerSpecification = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Contact $signatureContact = null, $producerSpecification = null, array $producers = array(), array $customerImageUsages = array())
    {
        $this
            ->setFormat($format)
     ...
     * Set Format value
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentFormat $format
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaCertificateOfOriginDetail
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DateRange|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaCertificateOfOriginDetail
     */
    public function setBlanketPeriod(\NicholasCreativeMedia\FedExPHP\Ship\StructType\DateRange $blanketPeriod = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\NaftaImporterSpecificationType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\NaftaImporterSpecificationType::getValidValues()
    ...
    public function setImporterSpecification($importerSpecification = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\NaftaImporterSpecificationType::valueIsValid($importerSpecification)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $importerSpecification, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\NaftaImporterSpecificationType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaCertificateOfOriginDetail
     */
    public function setSignatureContact(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Contact $signatureContact = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\NaftaProducerSpecificationType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\NaftaProducerSpecificationType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $producerSpecification
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaCertificateOfOriginDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\NaftaProducerSpecificationType::valueIsValid($producerSpecification)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $producerSpecification, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\NaftaProducerSpecificationType::getValidValues())), __LINE__);
        }
    ...
    /**
     * Get Producers value
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaProducer[]|null
     */
    ...
    public function setProducers(array $producers = array())
    {
        foreach ($producers as $naftaCertificateOfOriginDetailProducersItem) {
            ...
            if (!$naftaCertificateOfOriginDetailProducersItem instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaProducer) {
                throw new \InvalidArgumentException(sprintf('The Producers property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaProducer, "%s" given', is_object($naftaCertificateOfOriginDetailProducersItem) ? get_class($naftaCertificateOfOriginDetailProducersItem) : gettype($naftaCertificateOfOriginDetailProducersItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaProducer $item
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaCertificateOfOriginDetail
     */
    public function addToProducers(\NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaProducer $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaProducer) {
            throw new \InvalidArgumentException(sprintf('The Producers property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\NaftaProducer, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Producers[] = $item;
        return $this;
    }
    ...
    public function setCustomerImageUsages(array $customerImageUsages = array())
    {
        foreach ($customerImageUsages as $naftaCertificateOfOriginDetailCustomerImageUsagesItem) {
            // validation for constraint: itemType
            if (!$naftaCertificateOfOriginDetailCustomerImageUsagesItem instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomerImageUsage) {
                throw new \InvalidArgumentException(sprintf('The CustomerImageUsages property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomerImageUsage, "%s" given', is_object($naftaCertificateOfOriginDetailCustomerImageUsagesItem) ? get_class($naftaCertificateOfOriginDetailCustomerImageUsagesItem) : gettype($naftaCertificateOfOriginDetailCustomerImageUsagesItem)), __LINE__);
            }
        }
