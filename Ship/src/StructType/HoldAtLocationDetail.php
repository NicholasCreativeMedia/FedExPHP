...
class HoldAtLocationDetail extends AbstractStructBase
{
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\ContactAndAddress $locationContactAndAddress
     * @param string $locationType
     */
    public function __construct($phoneNumber = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\ContactAndAddress $locationContactAndAddress = null, $locationType = null)
    {
        $this
     ...
     * @param string $phoneNumber
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\HoldAtLocationDetail
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\HoldAtLocationDetail
     */
    public function setLocationContactAndAddress(\NicholasCreativeMedia\FedExPHP\Ship\StructType\ContactAndAddress $locationContactAndAddress = null)
    {
    ...
    public function setLocationType($locationType = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\FedExLocationType::valueIsValid($locationType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $locationType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\FedExLocationType::getValidValues())), __LINE__);
        }
