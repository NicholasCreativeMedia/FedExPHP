...
class RateDiscount extends AbstractStructBase
{
     ...
     * @param float $percent
     */
    public function __construct($rateDiscountType = null, $description = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $amount = null, $percent = null)
    {
        $this
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RateDiscountType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RateDiscountType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $rateDiscountType
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\RateDiscount
     */
    public function setRateDiscountType($rateDiscountType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\RateDiscountType::valueIsValid($rateDiscountType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $rateDiscountType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RateDiscountType::getValidValues())), __LINE__);
        }
