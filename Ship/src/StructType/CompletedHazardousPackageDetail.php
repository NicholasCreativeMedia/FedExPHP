...
class CompletedHazardousPackageDetail extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\ValidatedHazardousContainer[]
     */
    public $Containers;
    /**
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\ValidatedHazardousContainer[] $containers
     */
     ...
     * @param string $referenceId
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CompletedHazardousPackageDetail
     */
    ...
    /**
     * Set LabelType value
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RadioactiveLabelType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RadioactiveLabelType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $labelType
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CompletedHazardousPackageDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\RadioactiveLabelType::valueIsValid($labelType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $labelType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RadioactiveLabelType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ValidatedHazardousContainer[]|null
     */
    ...
    public function setContainers(array $containers = array())
    {
        foreach ($containers as $completedHazardousPackageDetailContainersItem) {
            ...
            if (!$completedHazardousPackageDetailContainersItem instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\ValidatedHazardousContainer) {
                throw new \InvalidArgumentException(sprintf('The Containers property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\ValidatedHazardousContainer, "%s" given', is_object($completedHazardousPackageDetailContainersItem) ? get_class($completedHazardousPackageDetailContainersItem) : gettype($completedHazardousPackageDetailContainersItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\ValidatedHazardousContainer $item
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CompletedHazardousPackageDetail
     */
    public function addToContainers(\NicholasCreativeMedia\FedExPHP\Ship\StructType\ValidatedHazardousContainer $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\ValidatedHazardousContainer) {
            throw new \InvalidArgumentException(sprintf('The Containers property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\ValidatedHazardousContainer, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
