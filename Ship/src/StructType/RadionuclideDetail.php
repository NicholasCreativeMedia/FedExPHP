...
class RadionuclideDetail extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\RadionuclideActivity
     */
    public $Activity;
    /**
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\RadionuclideActivity $activity
     * @param bool $exceptedPackagingIsReportableQuantity
     * @param string $physicalForm
     * @param string $chemicalForm
     */
    public function __construct($radionuclide = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\RadionuclideActivity $activity = null, $exceptedPackagingIsReportableQuantity = null, $physicalForm = null, $chemicalForm = null)
    {
        $this
     ...
     * @param string $radionuclide
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\RadionuclideDetail
     */
    ...
    /**
     * Get Activity value
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\RadionuclideActivity|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\RadionuclideDetail
     */
    public function setActivity(\NicholasCreativeMedia\FedExPHP\Ship\StructType\RadionuclideActivity $activity = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PhysicalFormType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PhysicalFormType::getValidValues()
    ...
    public function setPhysicalForm($physicalForm = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\PhysicalFormType::valueIsValid($physicalForm)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $physicalForm, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PhysicalFormType::getValidValues())), __LINE__);
        }
