...
class HazardousCommodityDescription extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityPackingDetail
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityPackingDetail $packingDetails
     ...
     */
    public function __construct($id = null, $sequenceNumber = null, $packingGroup = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityPackingDetail $packingDetails = null, $reportableQuantity = null, $properShippingName = null, $technicalName = null, $percentage = null, $hazardClass = null, array $subsidiaryClasses = array(), $labelText = null, array $processingOptions = array(), $authorization = null)
    {
        $this
            ->setId($id)
     ...
     * Set Id value
     * @param string $id
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityDescription
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityPackingGroupType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityPackingGroupType::getValidValues()
    ...
    public function setPackingGroup($packingGroup = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityPackingGroupType::valueIsValid($packingGroup)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $packingGroup, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityPackingGroupType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityPackingDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityDescription
     */
    public function setPackingDetails(\NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityPackingDetail $packingDetails = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityDescriptionProcessingOptionType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityDescriptionProcessingOptionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string[] $processingOptions
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityDescription
     */
    public function setProcessingOptions(array $processingOptions = array())
    {
        ...
        foreach ($processingOptions as $hazardousCommodityDescriptionProcessingOptionsItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityDescriptionProcessingOptionType::valueIsValid($hazardousCommodityDescriptionProcessingOptionsItem)) {
                $invalidValues[] = var_export($hazardousCommodityDescriptionProcessingOptionsItem);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityDescriptionProcessingOptionType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityDescriptionProcessingOptionType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityDescriptionProcessingOptionType::getValidValues())), __LINE__);
        }
