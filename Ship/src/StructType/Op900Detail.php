...
class Op900Detail extends AbstractStructBase
{
     ...
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentFormat $format = null, $reference = null, array $customerImageUsages = array(), $signatureName = null)
    {
        $this
            ->setFormat($format)
     ...
     * Set Format value
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentFormat $format
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\Op900Detail
     */
    ...
    /**
     * Set Reference value
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomerReferenceType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomerReferenceType::getValidValues()
    ...
    public function setReference($reference = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomerReferenceType::valueIsValid($reference)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $reference, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomerReferenceType::getValidValues())), __LINE__);
        }
    ...
    public function setCustomerImageUsages(array $customerImageUsages = array())
    {
        foreach ($customerImageUsages as $op900DetailCustomerImageUsagesItem) {
            ...
            if (!$op900DetailCustomerImageUsagesItem instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomerImageUsage) {
                throw new \InvalidArgumentException(sprintf('The CustomerImageUsages property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomerImageUsage, "%s" given', is_object($op900DetailCustomerImageUsagesItem) ? get_class($op900DetailCustomerImageUsagesItem) : gettype($op900DetailCustomerImageUsagesItem)), __LINE__);
            }
        }
