...
class FreightBaseCharge extends AbstractStructBase
{
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $chargeRate
     * @param string $chargeBasis
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $extendedAmount
     */
    public function __construct($freightClass = null, $ratedAsClass = null, $nmfcCode = null, $description = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Weight $weight = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $chargeRate = null, $chargeBasis = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $extendedAmount = null)
    {
        $this
     ...
     * @param string $freightClass
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\FreightBaseCharge
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\FreightClassType::valueIsValid($ratedAsClass)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $ratedAsClass, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\FreightClassType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\FreightBaseCharge
     */
    public function setChargeRate(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $chargeRate = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\FreightChargeBasisType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\FreightChargeBasisType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $chargeBasis
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\FreightBaseCharge
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\FreightChargeBasisType::valueIsValid($chargeBasis)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $chargeBasis, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\FreightChargeBasisType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\FreightBaseCharge
     */
    public function setExtendedAmount(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $extendedAmount = null)
    {
