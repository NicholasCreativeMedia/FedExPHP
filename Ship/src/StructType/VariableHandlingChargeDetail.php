...
class VariableHandlingChargeDetail extends AbstractStructBase
{
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $fixedValue
     * @param float $percentValue
     * @param string $rateElementBasis
     * @param string $rateTypeBasis
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $fixedValue = null, $percentValue = null, $rateElementBasis = null, $rateTypeBasis = null)
    {
        $this
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $fixedValue
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\VariableHandlingChargeDetail
     */
    public function setFixedValue(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $fixedValue = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RateElementBasisType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RateElementBasisType::getValidValues()
    ...
    public function setRateElementBasis($rateElementBasis = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\RateElementBasisType::valueIsValid($rateElementBasis)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $rateElementBasis, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RateElementBasisType::getValidValues())), __LINE__);
        }
