...
class UploadDocumentReferenceDetail extends AbstractStructBase
{
     ...
     * @param int $lineNumber
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\UploadDocumentReferenceDetail
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentProducerType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentProducerType::getValidValues()
    ...
    public function setDocumentProducer($documentProducer = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentProducerType::valueIsValid($documentProducer)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $documentProducer, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentProducerType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $documentType
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\UploadDocumentReferenceDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentType::valueIsValid($documentType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $documentType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentIdProducer::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentIdProducer::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $documentIdProducer
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\UploadDocumentReferenceDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentIdProducer::valueIsValid($documentIdProducer)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $documentIdProducer, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\UploadDocumentIdProducer::getValidValues())), __LINE__);
        }
