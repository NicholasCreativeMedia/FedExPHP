...
class CustomDeliveryWindowDetail extends AbstractStructBase
{
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\DateRange $requestRange
     * @param string $requestDate
     */
    public function __construct($type = null, $requestTime = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\DateRange $requestRange = null, $requestDate = null)
    {
        $this
            ->setType($type)
    ...
    /**
     * Set Type value
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomDeliveryWindowType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomDeliveryWindowType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomDeliveryWindowDetail
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomDeliveryWindowType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomDeliveryWindowType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomDeliveryWindowDetail
     */
    public function setRequestRange(\NicholasCreativeMedia\FedExPHP\Ship\StructType\DateRange $requestRange = null)
    {
