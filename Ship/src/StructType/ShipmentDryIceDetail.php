...
class ShipmentDryIceDetail extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentDryIceProcessingOptionsRequested
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentDryIceProcessingOptionsRequested $processingOptions
     */
    public function __construct($packageCount = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Weight $totalWeight = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentDryIceProcessingOptionsRequested $processingOptions = null)
    {
        $this
     ...
     * @param int $packageCount
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentDryIceDetail
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentDryIceProcessingOptionsRequested|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentDryIceDetail
     */
    public function setProcessingOptions(\NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentDryIceProcessingOptionsRequested $processingOptions = null)
    {
