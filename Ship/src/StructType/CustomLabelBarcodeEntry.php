...
class CustomLabelBarcodeEntry extends AbstractStructBase
{
     ...
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelPosition $position = null, $barcodeSymbology = null, $format = null, array $dataFields = array(), $barHeight = null, $thinBarWidth = null)
    {
        $this
     ...
     * Set Position value
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelPosition $position
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelBarcodeEntry
     */
    ...
    public function setBarcodeSymbology($barcodeSymbology = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\BarcodeSymbologyType::valueIsValid($barcodeSymbology)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $barcodeSymbology, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\BarcodeSymbologyType::getValidValues())), __LINE__);
        }
