...
class ExportDetail extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\DestinationControlDetail
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\DestinationControlDetail $destinationControlDetail
     */
    public function __construct($b13AFilingOption = null, $exportComplianceStatement = null, $permitNumber = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\DestinationControlDetail $destinationControlDetail = null)
    {
        $this
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\B13AFilingOptionType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\B13AFilingOptionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $b13AFilingOption
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ExportDetail
     */
    public function setB13AFilingOption($b13AFilingOption = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\B13AFilingOptionType::valueIsValid($b13AFilingOption)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $b13AFilingOption, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\B13AFilingOptionType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DestinationControlDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ExportDetail
     */
    public function setDestinationControlDetail(\NicholasCreativeMedia\FedExPHP\Ship\StructType\DestinationControlDetail $destinationControlDetail = null)
    {
