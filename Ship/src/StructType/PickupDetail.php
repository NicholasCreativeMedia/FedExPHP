...
class PickupDetail extends AbstractStructBase
{
     ...
     * @param string $readyDateTime
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\PickupDetail
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PickupRequestType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PickupRequestType::getValidValues()
    ...
    public function setRequestType($requestType = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\PickupRequestType::valueIsValid($requestType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $requestType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PickupRequestType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PickupRequestSourceType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PickupRequestSourceType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $requestSource
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\PickupDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\PickupRequestSourceType::valueIsValid($requestSource)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $requestSource, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PickupRequestSourceType::getValidValues())), __LINE__);
        }
