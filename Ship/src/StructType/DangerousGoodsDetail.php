...
class DangerousGoodsDetail extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer[]
     */
    public $Containers;
    /**
     * The Packaging
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityPackagingDetail
     */
    public $Packaging;
    /**
     * The Signatory
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsSignatory
     */
    public $Signatory;
    /**
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\Contact
     */
     ...
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\RadioactivityDetail
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer[] $containers
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityPackagingDetail $packaging
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsSignatory $signatory
     * @param string $emergencyContactNumber
     * @param string $offeror
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Contact $infectiousSubstanceResponsibleContact
     * @param string $additionalHandling
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\RadioactivityDetail $radioactivityDetail
     */
    public function __construct($uploadedTrackingNumber = null, $regulation = null, $accessibility = null, $cargoAircraftOnly = null, array $options = array(), $packingOption = null, $referenceId = null, array $containers = array(), \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityPackagingDetail $packaging = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsSignatory $signatory = null, $emergencyContactNumber = null, $offeror = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Contact $infectiousSubstanceResponsibleContact = null, $additionalHandling = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\RadioactivityDetail $radioactivityDetail = null)
    {
        $this
     ...
     * @param string $uploadedTrackingNumber
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityRegulationType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityRegulationType::getValidValues()
    ...
    public function setRegulation($regulation = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityRegulationType::valueIsValid($regulation)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $regulation, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityRegulationType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DangerousGoodsAccessibilityType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DangerousGoodsAccessibilityType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $accessibility
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\DangerousGoodsAccessibilityType::valueIsValid($accessibility)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $accessibility, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DangerousGoodsAccessibilityType::getValidValues())), __LINE__);
        }
    ...
    public function setOptions(array $options = array())
    {
        ...
        foreach ($options as $dangerousGoodsDetailOptionsItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityOptionType::valueIsValid($dangerousGoodsDetailOptionsItem)) {
                $invalidValues[] = var_export($dangerousGoodsDetailOptionsItem);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityOptionType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityOptionType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousCommodityOptionType::getValidValues())), __LINE__);
        }
        $this->Options[] = $item;
        return $this;
    }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DangerousGoodsPackingOptionType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DangerousGoodsPackingOptionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $packingOption
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\DangerousGoodsPackingOptionType::valueIsValid($packingOption)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $packingOption, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DangerousGoodsPackingOptionType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer[]|null
     */
    ...
    public function setContainers(array $containers = array())
    {
        foreach ($containers as $dangerousGoodsDetailContainersItem) {
            ...
            if (!$dangerousGoodsDetailContainersItem instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer) {
                throw new \InvalidArgumentException(sprintf('The Containers property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer, "%s" given', is_object($dangerousGoodsDetailContainersItem) ? get_class($dangerousGoodsDetailContainersItem) : gettype($dangerousGoodsDetailContainersItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer $item
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail
     */
    public function addToContainers(\NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer) {
            throw new \InvalidArgumentException(sprintf('The Containers property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
    ...
    /**
     * Get Packaging value
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityPackagingDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail
     */
    public function setPackaging(\NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityPackagingDetail $packaging = null)
    {
    ...
    /**
     * Get Signatory value
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsSignatory|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail
     */
    public function setSignatory(\NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsSignatory $signatory = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\Contact|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail
     */
    public function setInfectiousSubstanceResponsibleContact(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Contact $infectiousSubstanceResponsibleContact = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\RadioactivityDetail|null
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsDetail
     */
    public function setRadioactivityDetail(\NicholasCreativeMedia\FedExPHP\Ship\StructType\RadioactivityDetail $radioactivityDetail = null)
    {
