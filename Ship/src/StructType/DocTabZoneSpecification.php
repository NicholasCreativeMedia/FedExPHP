...
class DocTabZoneSpecification extends AbstractStructBase
{
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DocTabZoneJustificationType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DocTabZoneJustificationType::getValidValues()
    ...
    public function setJustification($justification = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\DocTabZoneJustificationType::valueIsValid($justification)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $justification, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DocTabZoneJustificationType::getValidValues())), __LINE__);
        }
