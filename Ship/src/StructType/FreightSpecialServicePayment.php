...
class FreightSpecialServicePayment extends AbstractStructBase
{
     ...
     * @param string $specialService
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\FreightSpecialServicePayment
     */
    public function setSpecialService($specialService = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\ShipmentSpecialServiceType::valueIsValid($specialService)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $specialService, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\ShipmentSpecialServiceType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\FreightShipmentRoleType::valueIsValid($paymentType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $paymentType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\FreightShipmentRoleType::getValidValues())), __LINE__);
        }
