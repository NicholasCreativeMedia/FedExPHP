...
class InternationalControlledExportDetail extends AbstractStructBase
{
    ...
    /**
     * Set Type value
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\InternationalControlledExportType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\InternationalControlledExportType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\InternationalControlledExportDetail
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\InternationalControlledExportType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\InternationalControlledExportType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
