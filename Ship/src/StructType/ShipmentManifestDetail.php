...
class ShipmentManifestDetail extends AbstractStructBase
{
     ...
     * @param string $manifestReferenceType
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentManifestDetail
     */
    public function setManifestReferenceType($manifestReferenceType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomerReferenceType::valueIsValid($manifestReferenceType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $manifestReferenceType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomerReferenceType::getValidValues())), __LINE__);
        }
