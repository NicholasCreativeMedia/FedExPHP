...
class Weight extends AbstractStructBase
{
    ...
    /**
     * Set Units value
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\WeightUnits::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\WeightUnits::getValidValues()
    ...
    public function setUnits($units = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\WeightUnits::valueIsValid($units)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $units, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\WeightUnits::getValidValues())), __LINE__);
        }
        $this->Units = $units;
        return $this;
    }
