...
class CommercialInvoice extends AbstractStructBase
{
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $freightCharge
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $taxesOrMiscellaneousCharge
     * @param string $taxesOrMiscellaneousChargeType
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $packingCosts
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $handlingCosts
     ...
     */
    public function __construct(array $comments = array(), \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $freightCharge = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $taxesOrMiscellaneousCharge = null, $taxesOrMiscellaneousChargeType = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $packingCosts = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $handlingCosts = null, $specialInstructions = null, $declarationStatement = null, $paymentTerms = null, $purpose = null, array $customerReferences = array(), $originatorName = null, $termsOfSale = null)
    {
        $this
     ...
     * @param string[] $comments
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CommercialInvoice
     */
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CommercialInvoice
     */
    public function setFreightCharge(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $freightCharge = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CommercialInvoice
     */
    public function setTaxesOrMiscellaneousCharge(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $taxesOrMiscellaneousCharge = null)
    {
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\TaxesOrMiscellaneousChargeType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\TaxesOrMiscellaneousChargeType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $taxesOrMiscellaneousChargeType
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CommercialInvoice
     */
    public function setTaxesOrMiscellaneousChargeType($taxesOrMiscellaneousChargeType = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\TaxesOrMiscellaneousChargeType::valueIsValid($taxesOrMiscellaneousChargeType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $taxesOrMiscellaneousChargeType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\TaxesOrMiscellaneousChargeType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CommercialInvoice
     */
    public function setPackingCosts(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $packingCosts = null)
    {
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CommercialInvoice
     */
    public function setHandlingCosts(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Money $handlingCosts = null)
    {
    ...
    /**
     * Set Purpose value
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PurposeOfShipmentType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PurposeOfShipmentType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $purpose
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CommercialInvoice
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\PurposeOfShipmentType::valueIsValid($purpose)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $purpose, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\PurposeOfShipmentType::getValidValues())), __LINE__);
        }
