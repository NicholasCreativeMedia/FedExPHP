...
class DangerousGoodsShippersDeclarationDetail extends AbstractStructBase
{
     ...
     * Set Format value
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentFormat $format
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsShippersDeclarationDetail
     */
    ...
    public function setCustomerImageUsages(array $customerImageUsages = array())
    {
        foreach ($customerImageUsages as $dangerousGoodsShippersDeclarationDetailCustomerImageUsagesItem) {
            ...
            if (!$dangerousGoodsShippersDeclarationDetailCustomerImageUsagesItem instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomerImageUsage) {
                throw new \InvalidArgumentException(sprintf('The CustomerImageUsages property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomerImageUsage, "%s" given', is_object($dangerousGoodsShippersDeclarationDetailCustomerImageUsagesItem) ? get_class($dangerousGoodsShippersDeclarationDetailCustomerImageUsagesItem) : gettype($dangerousGoodsShippersDeclarationDetailCustomerImageUsagesItem)), __LINE__);
            }
        }
