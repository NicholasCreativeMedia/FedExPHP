...
class SignatureOptionDetail extends AbstractStructBase
{
     ...
     * @param string $optionType
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\SignatureOptionDetail
     */
    public function setOptionType($optionType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\SignatureOptionType::valueIsValid($optionType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $optionType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\SignatureOptionType::getValidValues())), __LINE__);
        }
