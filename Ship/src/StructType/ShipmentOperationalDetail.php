...
class ShipmentOperationalDetail extends AbstractStructBase
{
     ...
     * @param string $ursaPrefixCode
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentOperationalDetail
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DayOfWeekType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DayOfWeekType::getValidValues()
    ...
    public function setDeliveryDay($deliveryDay = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\DayOfWeekType::valueIsValid($deliveryDay)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $deliveryDay, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DayOfWeekType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\DayOfWeekType::valueIsValid($commitDay)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $commitDay, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\DayOfWeekType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\TransitTimeType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\TransitTimeType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $transitTime
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentOperationalDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\TransitTimeType::valueIsValid($transitTime)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $transitTime, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\TransitTimeType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\TransitTimeType::valueIsValid($maximumTransitTime)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $maximumTransitTime, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\TransitTimeType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\TransitTimeType::valueIsValid($customTransitTime)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $customTransitTime, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\TransitTimeType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\GroundDeliveryEligibilityType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\GroundDeliveryEligibilityType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string[] $deliveryEligibilities
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShipmentOperationalDetail
     */
    public function setDeliveryEligibilities(array $deliveryEligibilities = array())
    {
        ...
        foreach ($deliveryEligibilities as $shipmentOperationalDetailDeliveryEligibilitiesItem) {
            if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\GroundDeliveryEligibilityType::valueIsValid($shipmentOperationalDetailDeliveryEligibilitiesItem)) {
                $invalidValues[] = var_export($shipmentOperationalDetailDeliveryEligibilitiesItem);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\GroundDeliveryEligibilityType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\GroundDeliveryEligibilityType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\GroundDeliveryEligibilityType::getValidValues())), __LINE__);
        }
