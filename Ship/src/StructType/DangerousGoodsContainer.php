...
class DangerousGoodsContainer extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityContent[]
     */
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityContent[] $hazardousCommodities
     */
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousContainerPackingType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousContainerPackingType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $packingType
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer
     */
    public function setPackingType($packingType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousContainerPackingType::valueIsValid($packingType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $packingType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\HazardousContainerPackingType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RadioactiveContainerClassType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RadioactiveContainerClassType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $radioactiveContainerClass
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\RadioactiveContainerClassType::valueIsValid($radioactiveContainerClass)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $radioactiveContainerClass, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RadioactiveContainerClassType::getValidValues())), __LINE__);
        }
     ...
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityContent[]|null
     */
    ...
    public function setHazardousCommodities(array $hazardousCommodities = array())
    {
        foreach ($hazardousCommodities as $dangerousGoodsContainerHazardousCommoditiesItem) {
            ...
            if (!$dangerousGoodsContainerHazardousCommoditiesItem instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityContent) {
                throw new \InvalidArgumentException(sprintf('The HazardousCommodities property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityContent, "%s" given', is_object($dangerousGoodsContainerHazardousCommoditiesItem) ? get_class($dangerousGoodsContainerHazardousCommoditiesItem) : gettype($dangerousGoodsContainerHazardousCommoditiesItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityContent $item
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\DangerousGoodsContainer
     */
    public function addToHazardousCommodities(\NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityContent $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityContent) {
            throw new \InvalidArgumentException(sprintf('The HazardousCommodities property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\HazardousCommodityContent, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
