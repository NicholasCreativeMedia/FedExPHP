...
class CompletedSmartPostDetail extends AbstractStructBase
{
     ...
     * @param string $pickUpCarrier
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CompletedSmartPostDetail
     */
    public function setPickUpCarrier($pickUpCarrier = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\CarrierCodeType::valueIsValid($pickUpCarrier)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $pickUpCarrier, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\CarrierCodeType::getValidValues())), __LINE__);
        }
