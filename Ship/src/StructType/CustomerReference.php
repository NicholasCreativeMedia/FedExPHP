...
class CustomerReference extends AbstractStructBase
{
     ...
     * @param string $customerReferenceType
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomerReference
     */
    public function setCustomerReferenceType($customerReferenceType = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomerReferenceType::valueIsValid($customerReferenceType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $customerReferenceType, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\CustomerReferenceType::getValidValues())), __LINE__);
        }
