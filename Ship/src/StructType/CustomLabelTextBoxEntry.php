...
class CustomLabelTextBoxEntry extends AbstractStructBase
{
     ...
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelPosition $topLeftCorner = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelPosition $bottomRightCorner = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelPosition $position = null, $format = null, array $dataFields = array(), $thermalFontId = null, $fontName = null, $fontSize = null, $rotation = null)
    {
        $this
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelPosition $topLeftCorner
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelTextBoxEntry
     */
    ...
    /**
     * Set Rotation value
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RotationType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RotationType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $rotation
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelTextBoxEntry
     */
    public function setRotation($rotation = null)
    {
        ...
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\RotationType::valueIsValid($rotation)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $rotation, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\RotationType::getValidValues())), __LINE__);
        }
