...
class Payor extends AbstractStructBase
{
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Party $responsibleParty
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Party $responsibleParty = null)
    {
        $this
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Party $responsibleParty
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\Payor
     */
    public function setResponsibleParty(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Party $responsibleParty = null)
    {
