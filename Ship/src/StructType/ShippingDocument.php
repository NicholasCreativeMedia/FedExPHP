...
class ShippingDocument extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentPart[]
     */
    public $Parts;
    /**
     ...
     * @param string $type
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Localization[] $localizations
     ...
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentPart[] $parts
     */
    ...
    /**
     * Set Type value
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\ReturnedShippingDocumentType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\ReturnedShippingDocumentType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocument
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\ReturnedShippingDocumentType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\ReturnedShippingDocumentType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
    ...
    public function setLocalizations(array $localizations = array())
    {
        foreach ($localizations as $shippingDocumentLocalizationsItem) {
            ...
            if (!$shippingDocumentLocalizationsItem instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\Localization) {
                throw new \InvalidArgumentException(sprintf('The Localizations property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\Localization, "%s" given', is_object($shippingDocumentLocalizationsItem) ? get_class($shippingDocumentLocalizationsItem) : gettype($shippingDocumentLocalizationsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\Localization $item
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocument
     */
    public function addToLocalizations(\NicholasCreativeMedia\FedExPHP\Ship\StructType\Localization $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\Localization) {
            throw new \InvalidArgumentException(sprintf('The Localizations property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\Localization, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
    ...
    /**
     * Set Grouping value
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\ShippingDocumentGroupingType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\ShippingDocumentGroupingType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $grouping
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocument
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\ShippingDocumentGroupingType::valueIsValid($grouping)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $grouping, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\ShippingDocumentGroupingType::getValidValues())), __LINE__);
        }
     ...
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\ShippingDocumentDispositionType::valueIsValid()
     * @uses \NicholasCreativeMedia\FedExPHP\Ship\EnumType\ShippingDocumentDispositionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $shippingDocumentDisposition
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocument
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\NicholasCreativeMedia\FedExPHP\Ship\EnumType\ShippingDocumentDispositionType::valueIsValid($shippingDocumentDisposition)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $shippingDocumentDisposition, implode(', ', \NicholasCreativeMedia\FedExPHP\Ship\EnumType\ShippingDocumentDispositionType::getValidValues())), __LINE__);
        }
    ...
    /**
     * Get Parts value
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentPart[]|null
     */
    ...
    public function setParts(array $parts = array())
    {
        foreach ($parts as $shippingDocumentPartsItem) {
            // validation for constraint: itemType
            if (!$shippingDocumentPartsItem instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentPart) {
                throw new \InvalidArgumentException(sprintf('The Parts property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentPart, "%s" given', is_object($shippingDocumentPartsItem) ? get_class($shippingDocumentPartsItem) : gettype($shippingDocumentPartsItem)), __LINE__);
            }
        }
        $this->Parts = $parts;
        return $this;
     ...
     * @throws \InvalidArgumentException
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentPart $item
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocument
     */
    public function addToParts(\NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentPart $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentPart) {
            throw new \InvalidArgumentException(sprintf('The Parts property can only contain items of \NicholasCreativeMedia\FedExPHP\Ship\StructType\ShippingDocumentPart, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Parts[] = $item;
        return $this;
    }
