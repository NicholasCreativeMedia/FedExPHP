...
class ClientDetail extends AbstractStructBase
{
     ...
     */
    public function __construct($accountNumber = null, $meterNumber = null, $integratorId = null, \NicholasCreativeMedia\FedExPHP\Ship\StructType\Localization $localization = null)
    {
        $this
