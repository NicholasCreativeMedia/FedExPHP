...
class CustomLabelTextEntry extends AbstractStructBase
{
     ...
     */
    public function __construct(\NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelPosition $position = null, $format = null, array $dataFields = array(), $thermalFontId = null, $fontName = null, $fontSize = null, $rotation = null)
    {
        $this
     ...
     * Set Position value
     * @param \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelPosition $position
     * @return \NicholasCreativeMedia\FedExPHP\Ship\StructType\CustomLabelTextEntry
     */
